---
layout: default
title : "Relations.Setoid.Quotients module (The Agda Universal Algebra Library)"
date : "2021-09-16"
...
This is the [Relations.Setoid.Quotients][] module of the [Agda Universal Algebra Library][].

\begin{code}

{-# OPTIONS --without-K --exact-split --safe #-}

module Relations.Setoid.Quotients where
...
open import Relations.Setoid.Discrete     using ( fker )
...
<span style="float:left;">[← Relations.Setoid.Discrete](Relations.Setoid.Discrete.html)</span>
