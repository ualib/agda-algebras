---
layout: default
title : "Relations.Setoid.Discrete module (The Agda Universal Algebra Library)"
date : "2021-09-16"
...
This is the [Relations.Setoid.Discrete][] module of the [Agda Universal Algebra Library][].

\begin{code}

{-# OPTIONS --without-K --exact-split --safe #-}

module Relations.Setoid.Discrete where
...
<span style="float:left;">[↑ Relations.Setoid](Relations.Setoid.html)</span>
<span style="float:right;">[Relations.Setoid.Quotients →](Relations.Setoid.Quotients.html)</span>
