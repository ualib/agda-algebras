...
The word *classical* names the long-standing tradition of concrete algebraic
structures, as distinct from the universal-algebraic treatment of
algebras-over-a-signature; it carries no commitment to classical logic, which the
library does not assume.[^2]
...
setoid-specific feature.  This discipline makes an eventual port to cubical Agda[^3]
substitutional rather than rewriting: replacing the setoid
...
[^1]: See [ADR-001][ADR-001].

[^2]: The design of this tree is recorded in [ADR-002][ADR-002].

[^3]: See [ADR-003][ADR-003].
