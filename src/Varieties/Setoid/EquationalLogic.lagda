...
This is the [Varieties.Setoid.EquationalLogic][] module of the [Agda Universal Algebra Library][] where the binary "models" relation ⊧, relating algebras (or classes of algebras) to the identities that they satisfy, is defined.
...
open import Algebras.Setoid.Basic {𝑆 = 𝑆} using ( Algebra ; ov )
...
<span style="float:right;">[Varieties.Setoid.SoundAndComplete →](Varieties.Setoid.SoundAndComplete.html)</span>
