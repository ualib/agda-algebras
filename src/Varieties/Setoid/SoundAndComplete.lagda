---
layout: default
title : "Varieties.Setoid.SoundAndComplete module (The Agda Universal Algebra Library)"
date : "2021-01-14"
...
This is the [Varieties.Setoid.SoundAndComplete][] module of the [Agda Universal Algebra Library][].
...
module Varieties.Setoid.SoundAndComplete {𝑆 : Signature 𝓞 𝓥} where
...
open import Algebras.Setoid.Basic   {𝑆 = 𝑆} using ( Algebra ; ov ) renaming ( ⟦_⟧ to ⟦_⟧s )
open import Terms.Basic           {𝑆 = 𝑆} using ( Term )
open import Terms.Setoid.Basic      {𝑆 = 𝑆} using ( module Environment ; Sub ; _[_] )
