...
open import Overture.Setoid.Inverses                   using ( eq )
...
open import Homomorphisms.Setoid.Basic         {𝑆 = 𝑆} using ( epi ; IsEpi ; IsHom ; hom ; epi→hom )
open import Homomorphisms.Setoid.Properties    {𝑆 = 𝑆} using ( ∘-epi ; ToLift-epi )
open import Terms.Basic                        {𝑆 = 𝑆} using ( ℊ )
open import Terms.Setoid.Basic                 {𝑆 = 𝑆} using ( 𝑻 ; _≐_ ; module Environment )
open import Terms.Setoid.Properties            {𝑆 = 𝑆} using ( free-lift )
open import Terms.Setoid.Operations            {𝑆 = 𝑆} using ( free-lift-interp )
open import Varieties.Setoid.SoundAndComplete  {𝑆 = 𝑆} using ( Eq ; _⊫_ ; _≈̇_ ; _⊢_▹_≈_ )
                                                       using ( module Soundness ; module FreeAlgebra )
                                                       using ( Th ; Mod )
open import Varieties.Setoid.Closure           {𝑆 = 𝑆} using ( V ; S )
open import Varieties.Setoid.Preservation      {𝑆 = 𝑆} using ( classIds-⊆-VIds ; S-id1 )
...
<span style="float:right;">[Varieties.Setoid.HSP](Varieties.Setoid.HSP.html)</span>
