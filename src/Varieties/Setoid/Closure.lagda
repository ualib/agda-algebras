---
layout: default
title : "Varieties.Setoid.Closure module (The Agda Universal Algebra Library)"
date : "2021-01-14"
...
open import Homomorphisms.Setoid.Basic              {𝑆 = 𝑆}  using ( IsHom )
open import Homomorphisms.Setoid.Isomorphisms       {𝑆 = 𝑆}  using ( _≅_ ; ≅-trans ; ≅-sym ; Lift-≅ ; ⨅≅⨅ℓρ )
open import Homomorphisms.Setoid.HomomorphicImages  {𝑆 = 𝑆}  using ( _IsHomImageOf_ ; IdHomImage ; HomImage-≅ )
                                                             using ( HomImage-≅' ; Lift-HomImage-lemma )
open import Subalgebras.Setoid.Subalgebras          {𝑆 = 𝑆}  using ( _≤_ ; _≤c_ )
open import Subalgebras.Setoid.Properties           {𝑆 = 𝑆}  using ( ≤-reflexive ; ≤-trans ; ≅-trans-≤ )
...
<span style="float:left;">[← Varieties.Setoid.SoundAndComplete](Varieties.Setoid.SoundAndComplete.html)</span>
<span style="float:right;">[Varieties.Setoid.Properties →](Varieties.Setoid.Properties.html)</span>
