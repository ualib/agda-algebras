...
open import Equality.Truncation                using ( is-set ; blk-uip ; hfunext )
open import Equality.Extensionality            using ( DFunExt; pred-ext )
...
open import Homomorphisms.Factor       {𝑆 = 𝑆} using ( HomFactor ; HomFactorEpi )
