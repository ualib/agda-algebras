...
open import Legacy.Base.Relations   using ( Im_⊆_ ; PredType )
open import Legacy.Base.Equality    using ( swelldef )
open import Legacy.Base.Terms       using ( Term ) -- ; _⟦_⟧ )

open import Legacy.Base.Structures.Basic  using ( signature ; structure ; _ᵒ_ ; sigl )
                                   using ( siglˡ ; siglʳ )
