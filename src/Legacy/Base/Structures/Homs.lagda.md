...
open import Legacy.Base.Functions        using ( Image_∋_ ; IsSurjective ; IsInjective )
open import Legacy.Base.Relations        using ( ker ; kerlift ; ⟪_⟫ ; mkblk )
...
open import Legacy.Base.Structures.Congruences  using ( con ; _╱_)
open import Legacy.Base.Structures.Products     using ( ⨅ )
