...
module Legacy.Base.Subalgebras.Subalgebras {𝑆 : Signature 𝓞 𝓥} where
...
open  import Legacy.Base.Equality  using ( swelldef ; is-set ; blk-uip ; pred-ext )

open  import Legacy.Base.Algebras       {𝑆 = 𝑆} using ( Algebra ; ov )
open  import Legacy.Base.Terms          {𝑆 = 𝑆} using ( 𝑻 ; Term )
open  import Legacy.Base.Homomorphisms  {𝑆 = 𝑆} using ( hom ; kercon ; ker[_⇒_]_↾_ )
