...
open import Homomorphisms.Setoid.Basic    {𝑆 = 𝑆}  using ( hom ; mon ; mon→intohom )
open import Homomorphisms.Setoid.Kernels  {𝑆 = 𝑆}  using ( kerquo )
open import Homomorphisms.Setoid.Noether  {𝑆 = 𝑆}  using ( FirstHomTheorem )
private variable
 α ρᵃ β ρᵇ ℓ : Level
