...
open import Overture.Setoid.Injective                   using ( id-is-injective ; module compose )
                                                        using ( IsInjective ; ∘-injective )
open import Algebras.Setoid.Basic              {𝑆 = 𝑆}  using ( Algebra ; Lift-Algˡ )
...
open import Homomorphisms.Setoid.Properties    {𝑆 = 𝑆}  using ( 𝒾𝒹 ; ∘-hom )
...
open import Subalgebras.Setoid.Subalgebras     {𝑆 = 𝑆}  using ( _≤_ ; _≥_ ; _IsSubalgebraOfClass_ ; _≤c_ )
