...
the closing theorem of this module shows that the Layer-S form above, at
exponent `2` over a base group with an apartness witness, implies excluded
middle, so no proof of it for such a group can land in the safe fragment.
