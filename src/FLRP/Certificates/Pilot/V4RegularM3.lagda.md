...
4, unary operations `e`, `a`, `b`, `ab` — is isomorphic to the lattice
"M3" (5 elements).  The engine's output below (normal-form
...
The claimed congruence lattice "M3", presented exactly as the
