---
layout: default
file: "src/FLRP/Certificates/SmallLatticeReps/SLR03.lagda.md"
title: "FLRP.Certificates.SmallLatticeReps.SLR03 module (The Agda Universal Algebra Library)"
date: "2026-07-22"
author: "the agda-algebras development team (emitted by scripts/python/flrp)"
---

### A machine-checked representation: Con(B3) ≅ manuscript L3

This is the [FLRP.Certificates.SmallLatticeReps.SLR03][] module of the [Agda Universal Algebra Library][].

**This module was emitted by `scripts/python/flrp/emit_agda.py` from
`scripts/python/flrp/inputs/slr/slr03.json`.  Do not edit it by hand; rerun the emitter instead.**

`B3`/`L3` in the numbering of the DeMeo–Freese–Jipsen manuscript *Representing Finite Lattices as Congruence Lattices of Finite Algebras* (§ 6 of the 2016-06-10 draft, `docs/papers/fin-lat-rep/SmallLatticeReps.tex`).  The dictionary between the manuscript's lattice numbering and this library's names is `docs/notes/flrp-slr-naming.md`.

It re-verifies, end-to-end through the WP-6 certificate pipeline (#457), the
claim that the congruence lattice of the algebra "B3" — carrier size
7, unary operations `f`, `g`, `h`, `k` — is isomorphic to the lattice
"manuscript L3" (6 elements).  The engine's output below (normal-form
...
module FLRP.Certificates.SmallLatticeReps.SLR03 where
...
```agda
opTables : Vec (Vec (Fin 7) 7) 4
opTables = (0F ∷ 1F ∷ 2F ∷ 1F ∷ 2F ∷ 1F ∷ 0F ∷ [])
         ∷ (0F ∷ 3F ∷ 4F ∷ 3F ∷ 4F ∷ 3F ∷ 0F ∷ [])
         ∷ (6F ∷ 5F ∷ 2F ∷ 5F ∷ 2F ∷ 5F ∷ 6F ∷ [])
         ∷ (0F ∷ 1F ∷ 2F ∷ 0F ∷ 0F ∷ 2F ∷ 2F ∷ [])
         ∷ []

𝑨 : Algebra {𝑆 = Sig-Unary (Fin 4)} 0ℓ 0ℓ
𝑨 = tablesToUnaryAlgebra 7 4 opTables

𝑭 : FiniteAlgebra 𝑨
𝑭 = tablesToUnaryAlgebra-FiniteAlgebra 7 4 opTables
...
The claimed congruence lattice "manuscript L3", presented exactly as the
...
cert : LatticeCert 7 4 arOf 6
cert = mkLatticeCert partsᵛ 0F prinᵛ prinTrᵛ ∧-table ∨-table joinTrᵛ
  where
  partsᵛ : Vec (ParentVec 7) 6
  partsᵛ = (0F ∷ 1F ∷ 2F ∷ 3F ∷ 4F ∷ 5F ∷ 6F ∷ [])
         ∷ (0F ∷ 1F ∷ 0F ∷ 3F ∷ 0F ∷ 5F ∷ 0F ∷ [])
         ∷ (0F ∷ 0F ∷ 2F ∷ 0F ∷ 4F ∷ 5F ∷ 5F ∷ [])
         ∷ (0F ∷ 1F ∷ 1F ∷ 3F ∷ 3F ∷ 1F ∷ 6F ∷ [])
         ∷ (0F ∷ 1F ∷ 0F ∷ 3F ∷ 0F ∷ 3F ∷ 0F ∷ [])
         ∷ (0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ [])
         ∷ []

  prinᵛ : Vec (Vec (Fin 6) 7) 7
  prinᵛ = (0F ∷ 2F ∷ 1F ∷ 2F ∷ 1F ∷ 5F ∷ 1F ∷ [])
        ∷ (2F ∷ 0F ∷ 3F ∷ 2F ∷ 5F ∷ 3F ∷ 5F ∷ [])
        ∷ (1F ∷ 3F ∷ 0F ∷ 5F ∷ 1F ∷ 3F ∷ 1F ∷ [])
        ∷ (2F ∷ 2F ∷ 5F ∷ 0F ∷ 3F ∷ 4F ∷ 5F ∷ [])
        ∷ (1F ∷ 5F ∷ 1F ∷ 3F ∷ 0F ∷ 5F ∷ 1F ∷ [])
        ∷ (5F ∷ 3F ∷ 3F ∷ 4F ∷ 5F ∷ 0F ∷ 2F ∷ [])
        ∷ (1F ∷ 5F ∷ 1F ∷ 5F ∷ 1F ∷ 2F ∷ 0F ∷ [])
        ∷ []

  prinTrᵛ : Vec (Vec (Trace 7 4 arOf) 7) 7
  prinTrᵛ = ( []
            ∷ ( mkMerge 0F 1F (seed 0)
              ∷ mkMerge 0F 3F (translate 1F 0F (0F ∷ []) 0)
              ∷ mkMerge 6F 5F (translate 2F 0F (0F ∷ []) 1)
              ∷ [] )
            ∷ ( mkMerge 0F 2F (seed 0)
              ∷ mkMerge 0F 4F (translate 1F 0F (0F ∷ []) 0)
              ∷ mkMerge 6F 2F (translate 2F 0F (0F ∷ []) 1)
              ∷ [] )
            ...
            ∷ ( mkMerge 0F 5F (seed 0)
              ...
              ∷ mkMerge 0F 2F (translate 3F 0F (0F ∷ []) 3)
              ∷ mkMerge 0F 4F (translate 1F 0F (0F ∷ []) 0)
              ∷ [] )
            ∷ ( mkMerge 0F 6F (seed 0)
              ∷ mkMerge 0F 2F (translate 3F 0F (0F ∷ []) 0)
              ∷ mkMerge 0F 4F (translate 1F 0F (0F ∷ []) 0)
              ∷ [] )
            ∷ [] )
          ∷ ( ( mkMerge 1F 0F (seed 0)
              ∷ mkMerge 3F 0F (translate 1F 0F (0F ∷ []) 0)
              ∷ mkMerge 5F 6F (translate 2F 0F (0F ∷ []) 1)
              ∷ [] )
            ∷ []
            ...
            ∷ ( mkMerge 1F 3F (seed 0)
              ∷ mkMerge 1F 0F (translate 3F 0F (0F ∷ []) 0)
              ∷ mkMerge 5F 6F (translate 2F 0F (0F ∷ []) 0)
              ∷ [] )
            ...
            ∷ ( mkMerge 1F 5F (seed 0)
              ∷ mkMerge 1F 2F (translate 3F 0F (0F ∷ []) 0)
              ∷ mkMerge 3F 4F (translate 1F 0F (0F ∷ []) 0)
              ∷ [] )
            ∷ ( mkMerge 1F 6F (seed 0)
              ...
              ∷ mkMerge 1F 2F (translate 3F 0F (0F ∷ []) 3)
              ∷ mkMerge 3F 4F (translate 1F 0F (0F ∷ []) 0)
              ∷ [] )
            ∷ [] )
          ∷ ( ( mkMerge 2F 0F (seed 0)
              ∷ mkMerge 4F 0F (translate 1F 0F (0F ∷ []) 0)
              ∷ mkMerge 2F 6F (translate 2F 0F (0F ∷ []) 1)
              ∷ [] )
            ...
            ∷ ( mkMerge 2F 3F (seed 0)
              ...
              ∷ mkMerge 2F 0F (translate 3F 0F (0F ∷ []) 3)
              ∷ mkMerge 2F 6F (translate 2F 0F (0F ∷ []) 0)
              ∷ [] )
            ∷ ( mkMerge 2F 4F (seed 0)
              ∷ mkMerge 2F 0F (translate 3F 0F (0F ∷ []) 0)
              ∷ mkMerge 2F 6F (translate 2F 0F (0F ∷ []) 0)
              ∷ [] )
          ...
          ∷ ( ( mkMerge 3F 0F (seed 0)
            ...
            ∷ ( mkMerge 3F 1F (seed 0)
              ∷ mkMerge 0F 1F (translate 3F 0F (0F ∷ []) 0)
              ∷ mkMerge 6F 5F (translate 2F 0F (0F ∷ []) 0)
              ∷ [] )
            ∷ ( mkMerge 3F 2F (seed 0)
              ...
              ∷ mkMerge 5F 2F (translate 2F 0F (0F ∷ []) 2)
              ∷ mkMerge 0F 2F (translate 3F 0F (0F ∷ []) 3)
              ∷ mkMerge 6F 2F (translate 2F 0F (0F ∷ []) 0)
              ∷ [] )
            ∷ []
          ...
          ∷ ( ( mkMerge 5F 0F (seed 0)
            ...
            ∷ ( mkMerge 5F 1F (seed 0)
              ∷ mkMerge 2F 1F (translate 3F 0F (0F ∷ []) 0)
              ∷ mkMerge 4F 3F (translate 1F 0F (0F ∷ []) 0)
              ∷ [] )
          ...
          ∷ ( ( mkMerge 6F 0F (seed 0)
            ...
            ∷ ( mkMerge 6F 1F (seed 0)
              ...
              ∷ mkMerge 0F 3F (translate 1F 0F (0F ∷ []) 1)
              ∷ mkMerge 6F 5F (translate 2F 0F (0F ∷ []) 2)
              ∷ mkMerge 2F 1F (translate 3F 0F (0F ∷ []) 3)
              ∷ mkMerge 4F 3F (translate 1F 0F (0F ∷ []) 0)
              ∷ [] )
  ...
  joinTrᵛ : Vec (Vec (Trace 7 4 arOf) 6) 6
  joinTrᵛ = ( []
            ∷ ( mkMerge 2F 0F (seed 0)
              ∷ mkMerge 4F 0F (seed 1)
              ∷ mkMerge 6F 0F (seed 2)
              ∷ [] )
            ∷ ( mkMerge 1F 0F (seed 0)
              ∷ mkMerge 3F 0F (seed 1)
              ∷ mkMerge 6F 5F (seed 2)
              ∷ [] )
            ∷ ( mkMerge 2F 1F (seed 0)
...
```agda
SLR03-Representableᵈ : Representableᵈ (toLattice 𝑳)
SLR03-Representableᵈ = certRepresentableᵈ 𝑭 𝑺 𝑳 cert certOK certMeet

SLR03-FiniteCongruencesᵈ : FiniteCongruencesᵈ 𝑨
SLR03-FiniteCongruencesᵈ = certFiniteCongruencesᵈ cert certOK
```
