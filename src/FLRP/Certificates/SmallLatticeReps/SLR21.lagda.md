---
layout: default
file: "src/FLRP/Certificates/SmallLatticeReps/SLR21.lagda.md"
title: "FLRP.Certificates.SmallLatticeReps.SLR21 module (The Agda Universal Algebra Library)"
date: "2026-07-22"
author: "the agda-algebras development team (emitted by scripts/python/flrp)"
---

### A machine-checked representation: Con(B21) ≅ manuscript L21

This is the [FLRP.Certificates.SmallLatticeReps.SLR21][] module of the [Agda Universal Algebra Library][].

**This module was emitted by `scripts/python/flrp/emit_agda.py` from
`scripts/python/flrp/inputs/slr/slr21.json`.  Do not edit it by hand; rerun the emitter instead.**

`B21`/`L21` in the numbering of the DeMeo–Freese–Jipsen manuscript *Representing Finite Lattices as Congruence Lattices of Finite Algebras* (§ 6 of the 2016-06-10 draft, `docs/papers/fin-lat-rep/SmallLatticeReps.tex`).  The dictionary between the manuscript's lattice numbering and this library's names is `docs/notes/flrp-slr-naming.md`.

It re-verifies, end-to-end through the WP-6 certificate pipeline (#457), the
claim that the congruence lattice of the algebra "B21" — carrier size
9, unary operations `f`, `g`, `h` — is isomorphic to the lattice
"manuscript L21" (7 elements).  The engine's output below (normal-form
...
module FLRP.Certificates.SmallLatticeReps.SLR21 where
...
opTables = (3F ∷ 3F ∷ 4F ∷ 8F ∷ 8F ∷ 2F ∷ 2F ∷ 3F ∷ 4F ∷ [])
         ∷ (0F ∷ 0F ∷ 6F ∷ 1F ∷ 1F ∷ 0F ∷ 0F ∷ 5F ∷ 6F ∷ [])
         ∷ (4F ∷ 5F ∷ 5F ∷ 7F ∷ 8F ∷ 8F ∷ 7F ∷ 4F ∷ 4F ∷ [])
         ∷ []
...
The claimed congruence lattice "manuscript L21", presented exactly as the
...
cert : LatticeCert 9 3 arOf 7
cert = mkLatticeCert partsᵛ 0F prinᵛ prinTrᵛ ∧-table ∨-table joinTrᵛ
  where
  partsᵛ : Vec (ParentVec 9) 7
  partsᵛ = (0F ∷ 1F ∷ 2F ∷ 3F ∷ 4F ∷ 5F ∷ 6F ∷ 7F ∷ 8F ∷ [])
         ∷ (0F ∷ 0F ∷ 2F ∷ 3F ∷ 4F ∷ 4F ∷ 6F ∷ 7F ∷ 2F ∷ [])
         ∷ (0F ∷ 1F ∷ 2F ∷ 3F ∷ 3F ∷ 5F ∷ 5F ∷ 7F ∷ 7F ∷ [])
         ∷ (0F ∷ 1F ∷ 2F ∷ 2F ∷ 4F ∷ 0F ∷ 1F ∷ 0F ∷ 4F ∷ [])
         ∷ (0F ∷ 0F ∷ 2F ∷ 3F ∷ 4F ∷ 4F ∷ 3F ∷ 7F ∷ 2F ∷ [])
         ∷ (0F ∷ 0F ∷ 2F ∷ 3F ∷ 3F ∷ 3F ∷ 3F ∷ 2F ∷ 2F ∷ [])
         ∷ (0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ [])
         ∷ []

  prinᵛ : Vec (Vec (Fin 7) 9) 9
  prinᵛ = (0F ∷ 1F ∷ 6F ∷ 6F ∷ 6F ∷ 3F ∷ 6F ∷ 3F ∷ 6F ∷ [])
        ∷ (1F ∷ 0F ∷ 6F ∷ 6F ∷ 6F ∷ 6F ∷ 3F ∷ 6F ∷ 6F ∷ [])
        ∷ (6F ∷ 6F ∷ 0F ∷ 3F ∷ 6F ∷ 6F ∷ 6F ∷ 5F ∷ 1F ∷ [])
        ∷ (6F ∷ 6F ∷ 3F ∷ 0F ∷ 2F ∷ 5F ∷ 4F ∷ 6F ∷ 6F ∷ [])
        ∷ (6F ∷ 6F ∷ 6F ∷ 2F ∷ 0F ∷ 1F ∷ 5F ∷ 6F ∷ 3F ∷ [])
        ∷ (3F ∷ 6F ∷ 6F ∷ 5F ∷ 1F ∷ 0F ∷ 2F ∷ 3F ∷ 6F ∷ [])
        ∷ (6F ∷ 3F ∷ 6F ∷ 4F ∷ 5F ∷ 2F ∷ 0F ∷ 6F ∷ 6F ∷ [])
        ∷ (3F ∷ 6F ∷ 5F ∷ 6F ∷ 6F ∷ 3F ∷ 6F ∷ 0F ∷ 2F ∷ [])
        ∷ (6F ∷ 6F ∷ 1F ∷ 6F ∷ 3F ∷ 6F ∷ 6F ∷ 2F ∷ 0F ∷ [])
        ∷ []
  ...
  prinTrᵛ = ( []
            ...
            ∷ ( mkMerge 0F 2F (seed 0)
              ...
              ∷ mkMerge 4F 7F (translate 2F 0F (0F ∷ []) 3)
            ...
            ∷ ( mkMerge 0F 4F (seed 0)
              ...
              ∷ mkMerge 7F 4F (translate 2F 0F (0F ∷ []) 3)
              ∷ mkMerge 4F 5F (translate 2F 0F (0F ∷ []) 3)
              ∷ mkMerge 3F 2F (translate 0F 0F (0F ∷ []) 2)
              ∷ [] )
            ...
            ∷ ( mkMerge 0F 6F (seed 0)
              ∷ mkMerge 3F 2F (translate 0F 0F (0F ∷ []) 0)
              ∷ mkMerge 4F 7F (translate 2F 0F (0F ∷ []) 1)
              ∷ mkMerge 8F 4F (translate 0F 0F (0F ∷ []) 1)
              ∷ mkMerge 1F 6F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 7F 5F (translate 2F 0F (0F ∷ []) 3)
            ...
            ∷ ( mkMerge 0F 8F (seed 0)
              ∷ mkMerge 3F 4F (translate 0F 0F (0F ∷ []) 0)
              ∷ mkMerge 0F 6F (translate 1F 0F (0F ∷ []) 1)
              ∷ mkMerge 7F 8F (translate 2F 0F (0F ∷ []) 1)
              ∷ mkMerge 3F 2F (translate 0F 0F (0F ∷ []) 1)
              ∷ mkMerge 4F 7F (translate 2F 0F (0F ∷ []) 2)
          ...
          ∷ ( ( mkMerge 1F 0F (seed 0)
            ...
            ∷ ( mkMerge 1F 3F (seed 0)
              ...
              ∷ mkMerge 8F 4F (translate 0F 0F (0F ∷ []) 2)
              ∷ mkMerge 1F 6F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 7F 4F (translate 2F 0F (0F ∷ []) 4)
            ...
            ∷ ( mkMerge 1F 5F (seed 0)
              ∷ mkMerge 3F 2F (translate 0F 0F (0F ∷ []) 0)
              ∷ mkMerge 5F 8F (translate 2F 0F (0F ∷ []) 1)
              ∷ mkMerge 8F 4F (translate 0F 0F (0F ∷ []) 1)
              ∷ mkMerge 1F 6F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 7F 5F (translate 2F 0F (0F ∷ []) 3)
              ∷ mkMerge 2F 4F (translate 0F 0F (0F ∷ []) 3)
            ...
            ∷ ( mkMerge 1F 6F (seed 0)
              ∷ mkMerge 3F 2F (translate 0F 0F (0F ∷ []) 0)
              ∷ mkMerge 5F 7F (translate 2F 0F (0F ∷ []) 1)
              ∷ mkMerge 8F 4F (translate 0F 0F (0F ∷ []) 1)
          ...
          ∷ ( ( mkMerge 2F 0F (seed 0)
            ...
            ∷ ( mkMerge 2F 1F (seed 0)
              ∷ mkMerge 4F 3F (translate 0F 0F (0F ∷ []) 0)
              ∷ mkMerge 6F 0F (translate 1F 0F (0F ∷ []) 1)
              ∷ mkMerge 8F 7F (translate 2F 0F (0F ∷ []) 1)
          ...
          ∷ ( ( mkMerge 3F 0F (seed 0)
            ...
            ∷ ( mkMerge 3F 1F (seed 0)
              ...
              ∷ mkMerge 4F 8F (translate 0F 0F (0F ∷ []) 2)
              ∷ mkMerge 6F 1F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 4F 7F (translate 2F 0F (0F ∷ []) 4)
            ...
            ∷ ( mkMerge 3F 4F (seed 0)
              ∷ mkMerge 7F 8F (translate 2F 0F (0F ∷ []) 0)
            ...
            ∷ ( mkMerge 3F 7F (seed 0)
              ...
              ∷ mkMerge 6F 1F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 3F 2F (translate 0F 0F (0F ∷ []) 2)
              ∷ mkMerge 5F 8F (translate 2F 0F (0F ∷ []) 3)
          ...
          ∷ ( ( mkMerge 4F 0F (seed 0)
            ...
            ∷ ( mkMerge 4F 3F (seed 0)
              ∷ mkMerge 8F 7F (translate 2F 0F (0F ∷ []) 0)
          ...
          ∷ ( ( mkMerge 5F 0F (seed 0)
            ...
            ∷ ( mkMerge 5F 1F (seed 0)
              ∷ mkMerge 2F 3F (translate 0F 0F (0F ∷ []) 0)
              ∷ mkMerge 8F 5F (translate 2F 0F (0F ∷ []) 1)
              ∷ mkMerge 4F 8F (translate 0F 0F (0F ∷ []) 1)
              ∷ mkMerge 6F 1F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 5F 7F (translate 2F 0F (0F ∷ []) 3)
              ∷ mkMerge 4F 2F (translate 0F 0F (0F ∷ []) 3)
          ...
          ∷ ( ( mkMerge 6F 0F (seed 0)
              ∷ mkMerge 2F 3F (translate 0F 0F (0F ∷ []) 0)
              ∷ mkMerge 7F 4F (translate 2F 0F (0F ∷ []) 1)
              ∷ mkMerge 4F 8F (translate 0F 0F (0F ∷ []) 1)
              ∷ mkMerge 6F 1F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 5F 7F (translate 2F 0F (0F ∷ []) 3)
            ...
            ∷ ( mkMerge 6F 1F (seed 0)
              ∷ mkMerge 2F 3F (translate 0F 0F (0F ∷ []) 0)
              ∷ mkMerge 7F 5F (translate 2F 0F (0F ∷ []) 1)
              ∷ mkMerge 4F 8F (translate 0F 0F (0F ∷ []) 1)
              ∷ mkMerge 5F 0F (translate 1F 0F (0F ∷ []) 1)
              ∷ [] )
          ...
          ∷ ( ( mkMerge 7F 0F (seed 0)
            ...
            ∷ ( mkMerge 7F 3F (seed 0)
              ...
              ∷ mkMerge 1F 6F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 2F 3F (translate 0F 0F (0F ∷ []) 2)
              ∷ mkMerge 8F 5F (translate 2F 0F (0F ∷ []) 3)
  ...
  joinTrᵛ : Vec (Vec (Trace 9 3 arOf) 7) 7
  joinTrᵛ = ( []
            ∷ ( mkMerge 1F 0F (seed 0)
          ...
          ∷ ( ( mkMerge 1F 0F (seed 0)
            ...
            ∷ ( mkMerge 1F 0F (seed 0)
              ...
              ∷ mkMerge 6F 5F (seed 4)
              ∷ mkMerge 8F 7F (seed 5)
              ∷ [] )
            ∷ ( mkMerge 1F 0F (seed 0)
              ∷ mkMerge 5F 4F (seed 1)
              ∷ mkMerge 8F 2F (seed 2)
              ...
              ∷ mkMerge 5F 0F (seed 4)
              ∷ mkMerge 6F 1F (seed 5)
              ∷ mkMerge 7F 0F (seed 6)
              ∷ mkMerge 8F 4F (seed 7)
              ∷ [] )
            ∷ ( mkMerge 1F 0F (seed 0)
              ∷ mkMerge 5F 4F (seed 1)
              ∷ mkMerge 8F 2F (seed 2)
              ∷ mkMerge 6F 3F (seed 5)
              ∷ [] )
            ∷ ( mkMerge 1F 0F (seed 0)
              ∷ mkMerge 5F 4F (seed 1)
              ∷ mkMerge 8F 2F (seed 2)
              ∷ mkMerge 4F 3F (seed 4)
              ∷ mkMerge 6F 3F (seed 6)
          ...
          ∷ ( ( mkMerge 3F 2F (seed 0)
            ...
            ∷ ( mkMerge 3F 2F (seed 0)
              ...
              ∷ mkMerge 6F 5F (seed 6)
              ∷ mkMerge 8F 7F (seed 7)
              ∷ [] )
            ∷ ( mkMerge 3F 2F (seed 0)
              ∷ mkMerge 5F 0F (seed 1)
              ∷ mkMerge 6F 1F (seed 2)
            ...
            ∷ ( mkMerge 3F 2F (seed 0)
              ...
              ∷ mkMerge 8F 4F (seed 4)
              ∷ mkMerge 1F 0F (seed 5)
              ∷ mkMerge 4F 3F (seed 6)
              ∷ mkMerge 5F 3F (seed 7)
              ∷ [] )
            ∷ ( mkMerge 3F 2F (seed 0)
              ∷ mkMerge 5F 0F (seed 1)
              ∷ mkMerge 6F 1F (seed 2)
...
```agda
SLR21-Representableᵈ : Representableᵈ (toLattice 𝑳)
SLR21-Representableᵈ = certRepresentableᵈ 𝑭 𝑺 𝑳 cert certOK certMeet

SLR21-FiniteCongruencesᵈ : FiniteCongruencesᵈ 𝑨
SLR21-FiniteCongruencesᵈ = certFiniteCongruencesᵈ cert certOK
```
