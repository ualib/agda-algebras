---
layout: default
file: "src/FLRP/Certificates/SmallLatticeReps/SLR17.lagda.md"
title: "FLRP.Certificates.SmallLatticeReps.SLR17 module (The Agda Universal Algebra Library)"
date: "2026-07-22"
author: "the agda-algebras development team (emitted by scripts/python/flrp)"
---

### A machine-checked representation: Con(B17) ≅ manuscript L17

This is the [FLRP.Certificates.SmallLatticeReps.SLR17][] module of the [Agda Universal Algebra Library][].

**This module was emitted by `scripts/python/flrp/emit_agda.py` from
`scripts/python/flrp/inputs/slr/slr17.json`.  Do not edit it by hand; rerun the emitter instead.**

`B17`/`L17` in the numbering of the DeMeo–Freese–Jipsen manuscript *Representing Finite Lattices as Congruence Lattices of Finite Algebras* (§ 6 of the 2016-06-10 draft, `docs/papers/fin-lat-rep/SmallLatticeReps.tex`).  The dictionary between the manuscript's lattice numbering and this library's names is `docs/notes/flrp-slr-naming.md`.

It re-verifies, end-to-end through the WP-6 certificate pipeline (#457), the
claim that the congruence lattice of the algebra "B17" — carrier size
12, unary operations `f`, `g`, `h` — is isomorphic to the lattice
"manuscript L17" (7 elements).  The engine's output below (normal-form
...
module FLRP.Certificates.SmallLatticeReps.SLR17 where
...
opTables = (1F ∷ 0F ∷ 3F ∷ 2F ∷ 5F ∷ 4F ∷ 7F ∷ 6F ∷ 9F ∷ 8F ∷ 11F ∷ 10F ∷ [])
         ∷ (4F ∷ 7F ∷ 5F ∷ 6F ∷ 8F ∷ 11F ∷ 9F ∷ 10F ∷ 0F ∷ 3F ∷ 1F ∷ 2F ∷ [])
         ∷ (0F ∷ 0F ∷ 0F ∷ 0F ∷ 5F ∷ 5F ∷ 5F ∷ 5F ∷ 10F ∷ 10F ∷ 10F ∷ 10F ∷ [])
         ∷ []
...
The claimed congruence lattice "manuscript L17", presented exactly as the
...
cert : LatticeCert 12 3 arOf 7
cert = mkLatticeCert partsᵛ 0F prinᵛ prinTrᵛ ∧-table ∨-table joinTrᵛ
  where
  partsᵛ : Vec (ParentVec 12) 7
  partsᵛ = (0F ∷ 1F ∷ 2F ∷ 3F ∷ 4F ∷ 5F ∷ 6F ∷ 7F ∷ 8F ∷ 9F ∷ 10F ∷ 11F ∷ [])
         ∷ (0F ∷ 0F ∷ 2F ∷ 2F ∷ 4F ∷ 5F ∷ 5F ∷ 4F ∷ 8F ∷ 9F ∷ 8F ∷ 9F ∷ [])
         ∷ (0F ∷ 1F ∷ 0F ∷ 1F ∷ 4F ∷ 4F ∷ 6F ∷ 6F ∷ 8F ∷ 9F ∷ 9F ∷ 8F ∷ [])
         ∷ (0F ∷ 1F ∷ 1F ∷ 0F ∷ 4F ∷ 5F ∷ 4F ∷ 5F ∷ 8F ∷ 8F ∷ 10F ∷ 10F ∷ [])
         ∷ (0F ∷ 1F ∷ 2F ∷ 3F ∷ 1F ∷ 0F ∷ 3F ∷ 2F ∷ 2F ∷ 3F ∷ 0F ∷ 1F ∷ [])
         ∷ (0F ∷ 0F ∷ 0F ∷ 0F ∷ 4F ∷ 4F ∷ 4F ∷ 4F ∷ 8F ∷ 8F ∷ 8F ∷ 8F ∷ [])
         ∷ (0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ [])
         ∷ []

  prinᵛ : Vec (Vec (Fin 7) 12) 12
  prinᵛ = (0F ∷ 1F ∷ 2F ∷ 3F ∷ 6F ∷ 4F ∷ 6F ∷ 6F ∷ 6F ∷ 6F ∷ 4F ∷ 6F ∷ [])
        ∷ (1F ∷ 0F ∷ 3F ∷ 2F ∷ 4F ∷ 6F ∷ 6F ∷ 6F ∷ 6F ∷ 6F ∷ 6F ∷ 4F ∷ [])
        ∷ (2F ∷ 3F ∷ 0F ∷ 1F ∷ 6F ∷ 6F ∷ 6F ∷ 4F ∷ 4F ∷ 6F ∷ 6F ∷ 6F ∷ [])
        ∷ (3F ∷ 2F ∷ 1F ∷ 0F ∷ 6F ∷ 6F ∷ 4F ∷ 6F ∷ 6F ∷ 4F ∷ 6F ∷ 6F ∷ [])
        ∷ (6F ∷ 4F ∷ 6F ∷ 6F ∷ 0F ∷ 2F ∷ 3F ∷ 1F ∷ 6F ∷ 6F ∷ 6F ∷ 4F ∷ [])
        ∷ (4F ∷ 6F ∷ 6F ∷ 6F ∷ 2F ∷ 0F ∷ 1F ∷ 3F ∷ 6F ∷ 6F ∷ 4F ∷ 6F ∷ [])
        ∷ (6F ∷ 6F ∷ 6F ∷ 4F ∷ 3F ∷ 1F ∷ 0F ∷ 2F ∷ 6F ∷ 4F ∷ 6F ∷ 6F ∷ [])
        ∷ (6F ∷ 6F ∷ 4F ∷ 6F ∷ 1F ∷ 3F ∷ 2F ∷ 0F ∷ 4F ∷ 6F ∷ 6F ∷ 6F ∷ [])
        ∷ (6F ∷ 6F ∷ 4F ∷ 6F ∷ 6F ∷ 6F ∷ 6F ∷ 4F ∷ 0F ∷ 3F ∷ 1F ∷ 2F ∷ [])
        ∷ (6F ∷ 6F ∷ 6F ∷ 4F ∷ 6F ∷ 6F ∷ 4F ∷ 6F ∷ 3F ∷ 0F ∷ 2F ∷ 1F ∷ [])
        ∷ (4F ∷ 6F ∷ 6F ∷ 6F ∷ 6F ∷ 4F ∷ 6F ∷ 6F ∷ 1F ∷ 2F ∷ 0F ∷ 3F ∷ [])
        ∷ (6F ∷ 4F ∷ 6F ∷ 6F ∷ 4F ∷ 6F ∷ 6F ∷ 6F ∷ 2F ∷ 1F ∷ 3F ∷ 0F ∷ [])
        ∷ []

  prinTrᵛ : Vec (Vec (Trace 12 3 arOf) 12) 12
  prinTrᵛ = ( []
            ∷ ( mkMerge 0F 1F (seed 0)
              ∷ mkMerge 4F 7F (translate 1F 0F (0F ∷ []) 0)
            ...
            ∷ ( mkMerge 0F 4F (seed 0)
              ...
              ∷ mkMerge 10F 2F (translate 1F 0F (0F ∷ []) 4)
            ...
            ∷ ( mkMerge 0F 5F (seed 0)
              ...
              ∷ mkMerge 5F 10F (translate 0F 0F (0F ∷ []) 1)
            ...
            ∷ ( mkMerge 0F 6F (seed 0)
              ...
              ∷ mkMerge 5F 10F (translate 2F 0F (0F ∷ []) 4)
              ∷ mkMerge 1F 4F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 4F 11F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 9F 2F (translate 0F 0F (0F ∷ []) 3)
              ∷ [] )
            ∷ ( mkMerge 0F 7F (seed 0)
              ...
              ∷ mkMerge 5F 11F (translate 0F 0F (0F ∷ []) 2)
              ∷ mkMerge 8F 1F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 5F 10F (translate 2F 0F (0F ∷ []) 4)
              ∷ mkMerge 1F 4F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 10F 3F (translate 1F 0F (0F ∷ []) 4)
              ∷ mkMerge 11F 2F (translate 1F 0F (0F ∷ []) 4)
              ∷ [] )
            ∷ ( mkMerge 0F 8F (seed 0)
              ...
              ∷ mkMerge 6F 2F (translate 0F 0F (0F ∷ []) 3)
            ...
            ∷ ( mkMerge 0F 9F (seed 0)
              ...
              ∷ mkMerge 5F 0F (translate 2F 0F (0F ∷ []) 4)
              ∷ mkMerge 1F 11F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 4F 1F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 10F 4F (translate 1F 0F (0F ∷ []) 5)
              ∷ [] )
            ∷ ( mkMerge 0F 10F (seed 0)
              ...
              ∷ mkMerge 8F 7F (translate 1F 0F (0F ∷ []) 2)
            ...
            ∷ ( mkMerge 0F 11F (seed 0)
              ...
              ∷ mkMerge 9F 4F (translate 0F 0F (0F ∷ []) 3)
              ∷ [] )
            ∷ [] )
          ∷ ( ( mkMerge 1F 0F (seed 0)
              ∷ mkMerge 7F 4F (translate 1F 0F (0F ∷ []) 0)
            ...
            ∷ ( mkMerge 1F 4F (seed 0)
              ...
              ∷ mkMerge 8F 2F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 9F 3F (translate 1F 0F (0F ∷ []) 2)
              ∷ [] )
            ∷ ( mkMerge 1F 5F (seed 0)
              ...
              ∷ mkMerge 10F 2F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 5F 10F (translate 2F 0F (0F ∷ []) 4)
            ...
            ∷ ( mkMerge 1F 6F (seed 0)
              ...
              ∷ mkMerge 10F 3F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 5F 10F (translate 2F 0F (0F ∷ []) 4)
              ∷ mkMerge 1F 4F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 4F 11F (translate 1F 0F (0F ∷ []) 5)
            ...
            ∷ ( mkMerge 1F 8F (seed 0)
              ...
              ∷ mkMerge 1F 11F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 4F 1F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 5F 2F (translate 0F 0F (0F ∷ []) 5)
              ∷ [] )
            ...
            ∷ ( mkMerge 1F 10F (seed 0)
              ...
              ∷ mkMerge 8F 5F (translate 1F 0F (0F ∷ []) 4)
          ...
          ∷ ( ( mkMerge 2F 0F (seed 0)
            ...
            ∷ ( mkMerge 2F 4F (seed 0)
              ...
              ∷ mkMerge 4F 9F (translate 0F 0F (0F ∷ []) 2)
            ...
            ∷ ( mkMerge 2F 5F (seed 0)
              ...
              ∷ mkMerge 5F 10F (translate 2F 0F (0F ∷ []) 3)
              ∷ mkMerge 1F 4F (translate 0F 0F (0F ∷ []) 3)
              ∷ mkMerge 7F 9F (translate 0F 0F (0F ∷ []) 3)
              ∷ mkMerge 9F 0F (translate 1F 0F (0F ∷ []) 4)
              ∷ mkMerge 8F 1F (translate 1F 0F (0F ∷ []) 4)
              ∷ [] )
            ∷ ( mkMerge 2F 6F (seed 0)
              ...
              ∷ mkMerge 1F 4F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 4F 11F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 9F 1F (translate 1F 0F (0F ∷ []) 5)
              ∷ [] )
            ...
            ∷ ( mkMerge 2F 9F (seed 0)
              ...
              ∷ mkMerge 1F 11F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 4F 1F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 7F 1F (translate 0F 0F (0F ∷ []) 5)
              ∷ [] )
            ∷ ( mkMerge 2F 10F (seed 0)
              ...
              ∷ mkMerge 5F 0F (translate 2F 0F (0F ∷ []) 4)
              ∷ mkMerge 1F 11F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 9F 5F (translate 1F 0F (0F ∷ []) 4)
            ...
            ∷ ( mkMerge 2F 11F (seed 0)
              ...
              ∷ mkMerge 0F 10F (translate 2F 0F (0F ∷ []) 2)
              ∷ mkMerge 6F 1F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 4F 3F (translate 0F 0F (0F ∷ []) 2)
              ∷ mkMerge 5F 0F (translate 2F 0F (0F ∷ []) 3)
              ∷ mkMerge 1F 11F (translate 0F 0F (0F ∷ []) 3)
              ∷ mkMerge 7F 0F (translate 0F 0F (0F ∷ []) 3)
          ...
          ∷ ( ( mkMerge 3F 0F (seed 0)
            ...
            ∷ ( mkMerge 3F 5F (seed 0)
              ...
              ∷ mkMerge 1F 4F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 4F 11F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 11F 0F (translate 1F 0F (0F ∷ []) 5)
              ∷ [] )
            ...
            ∷ ( mkMerge 3F 7F (seed 0)
              ...
              ∷ mkMerge 9F 1F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 5F 10F (translate 2F 0F (0F ∷ []) 4)
              ∷ mkMerge 1F 4F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 4F 11F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 4F 8F (translate 0F 0F (0F ∷ []) 5)
              ∷ [] )
            ...
            ∷ ( mkMerge 3F 11F (seed 0)
              ...
              ∷ mkMerge 9F 5F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 5F 0F (translate 2F 0F (0F ∷ []) 4)
              ∷ mkMerge 1F 11F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 4F 1F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 8F 4F (translate 0F 0F (0F ∷ []) 3)
              ∷ [] )
            ∷ [] )
          ∷ ( ( mkMerge 4F 0F (seed 0)
              ...
              ∷ mkMerge 2F 10F (translate 1F 0F (0F ∷ []) 4)
            ...
            ∷ ( mkMerge 4F 1F (seed 0)
              ...
              ∷ mkMerge 3F 9F (translate 1F 0F (0F ∷ []) 2)
              ∷ [] )
            ∷ ( mkMerge 4F 2F (seed 0)
              ...
              ∷ mkMerge 9F 4F (translate 0F 0F (0F ∷ []) 2)
              ∷ mkMerge 0F 11F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 10F 5F (translate 2F 0F (0F ∷ []) 4)
            ...
            ∷ ( mkMerge 4F 5F (seed 0)
              ∷ mkMerge 8F 11F (translate 1F 0F (0F ∷ []) 0)
            ...
            ∷ ( mkMerge 4F 9F (seed 0)
              ...
              ∷ mkMerge 10F 0F (translate 2F 0F (0F ∷ []) 4)
              ∷ mkMerge 4F 11F (translate 0F 0F (0F ∷ []) 4)
          ...
          ∷ ( ( mkMerge 5F 0F (seed 0)
              ...
              ∷ mkMerge 11F 4F (translate 1F 0F (0F ∷ []) 1)
              ∷ mkMerge 8F 7F (translate 1F 0F (0F ∷ []) 1)
              ∷ mkMerge 10F 5F (translate 0F 0F (0F ∷ []) 1)
              ∷ mkMerge 2F 8F (translate 1F 0F (0F ∷ []) 2)
            ...
            ∷ ( mkMerge 5F 1F (seed 0)
              ...
              ∷ mkMerge 2F 10F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 10F 5F (translate 2F 0F (0F ∷ []) 4)
            ...
            ∷ ( mkMerge 5F 2F (seed 0)
              ...
              ∷ mkMerge 9F 7F (translate 0F 0F (0F ∷ []) 3)
              ∷ mkMerge 0F 9F (translate 1F 0F (0F ∷ []) 4)
              ∷ mkMerge 1F 8F (translate 1F 0F (0F ∷ []) 4)
              ∷ [] )
            ∷ ( mkMerge 5F 3F (seed 0)
              ...
              ∷ mkMerge 4F 1F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 11F 4F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 0F 11F (translate 1F 0F (0F ∷ []) 5)
              ∷ [] )
            ∷ ( mkMerge 5F 4F (seed 0)
              ∷ mkMerge 11F 8F (translate 1F 0F (0F ∷ []) 0)
            ...
            ∷ ( mkMerge 5F 8F (seed 0)
              ...
              ∷ mkMerge 2F 4F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 10F 0F (translate 2F 0F (0F ∷ []) 4)
              ∷ mkMerge 4F 11F (translate 0F 0F (0F ∷ []) 4)
            ...
            ∷ ( mkMerge 5F 9F (seed 0)
              ...
              ∷ mkMerge 4F 11F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 11F 1F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 3F 7F (translate 0F 0F (0F ∷ []) 3)
              ∷ [] )
            ...
            ∷ ( mkMerge 5F 11F (seed 0)
              ...
              ∷ mkMerge 10F 0F (translate 2F 0F (0F ∷ []) 3)
              ∷ mkMerge 11F 1F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 9F 0F (translate 0F 0F (0F ∷ []) 3)
          ...
          ∷ ( ( mkMerge 6F 0F (seed 0)
              ...
              ∷ mkMerge 4F 1F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 11F 4F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 2F 9F (translate 0F 0F (0F ∷ []) 3)
              ∷ [] )
            ∷ ( mkMerge 6F 1F (seed 0)
              ...
              ∷ mkMerge 3F 10F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 10F 5F (translate 2F 0F (0F ∷ []) 4)
              ∷ mkMerge 4F 1F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 11F 4F (translate 1F 0F (0F ∷ []) 5)
            ...
            ∷ ( mkMerge 6F 2F (seed 0)
              ...
              ∷ mkMerge 4F 1F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 11F 4F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 1F 9F (translate 1F 0F (0F ∷ []) 5)
              ∷ [] )
            ...
            ∷ ( mkMerge 6F 7F (seed 0)
              ∷ mkMerge 9F 10F (translate 1F 0F (0F ∷ []) 0)
            ...
            ∷ ( mkMerge 6F 8F (seed 0)
              ...
              ∷ mkMerge 4F 11F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 11F 1F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 11F 2F (translate 0F 0F (0F ∷ []) 5)
              ∷ [] )
          ...
          ∷ ( ( mkMerge 7F 0F (seed 0)
            ...
            ∷ ( mkMerge 7F 3F (seed 0)
              ...
              ∷ mkMerge 1F 9F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 10F 5F (translate 2F 0F (0F ∷ []) 4)
              ∷ mkMerge 4F 1F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 11F 4F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 8F 4F (translate 0F 0F (0F ∷ []) 5)
              ∷ [] )
            ...
            ∷ ( mkMerge 7F 6F (seed 0)
              ∷ mkMerge 10F 9F (translate 1F 0F (0F ∷ []) 0)
            ...
            ∷ ( mkMerge 7F 10F (seed 0)
              ...
              ∷ mkMerge 5F 10F (translate 2F 0F (0F ∷ []) 2)
              ∷ mkMerge 9F 2F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 11F 0F (translate 0F 0F (0F ∷ []) 2)
              ∷ mkMerge 10F 0F (translate 2F 0F (0F ∷ []) 3)
              ∷ mkMerge 4F 11F (translate 0F 0F (0F ∷ []) 3)
              ∷ mkMerge 8F 3F (translate 0F 0F (0F ∷ []) 3)
            ...
            ∷ ( mkMerge 7F 11F (seed 0)
              ...
              ∷ mkMerge 5F 10F (translate 2F 0F (0F ∷ []) 2)
              ∷ mkMerge 9F 1F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 11F 3F (translate 0F 0F (0F ∷ []) 2)
          ...
          ∷ ( ( mkMerge 8F 0F (seed 0)
              ...
              ∷ mkMerge 2F 6F (translate 0F 0F (0F ∷ []) 3)
            ...
            ∷ ( mkMerge 8F 5F (seed 0)
              ...
              ∷ mkMerge 4F 2F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 0F 10F (translate 2F 0F (0F ∷ []) 4)
              ∷ mkMerge 11F 4F (translate 0F 0F (0F ∷ []) 4)
            ...
            ∷ ( mkMerge 8F 6F (seed 0)
              ...
              ∷ mkMerge 2F 11F (translate 0F 0F (0F ∷ []) 5)
              ∷ [] )
            ...
            ∷ ( mkMerge 8F 9F (seed 0)
              ...
              ∷ mkMerge 4F 6F (translate 1F 0F (0F ∷ []) 1)
              ∷ mkMerge 7F 5F (translate 1F 0F (0F ∷ []) 1)
              ∷ mkMerge 10F 11F (translate 1F 0F (0F ∷ []) 0)
              ∷ [] )
          ...
          ∷ ( ( mkMerge 9F 0F (seed 0)
              ...
              ∷ mkMerge 11F 1F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 1F 4F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 4F 10F (translate 1F 0F (0F ∷ []) 5)
              ∷ [] )
            ...
            ∷ ( mkMerge 9F 2F (seed 0)
              ...
              ∷ mkMerge 11F 1F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 1F 4F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 1F 7F (translate 0F 0F (0F ∷ []) 5)
              ∷ [] )
            ...
            ∷ ( mkMerge 9F 5F (seed 0)
              ...
              ∷ mkMerge 11F 4F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 1F 11F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 7F 3F (translate 0F 0F (0F ∷ []) 3)
              ∷ [] )
            ...
            ∷ ( mkMerge 9F 8F (seed 0)
              ...
              ∷ mkMerge 6F 4F (translate 1F 0F (0F ∷ []) 1)
              ∷ mkMerge 5F 7F (translate 1F 0F (0F ∷ []) 1)
              ∷ mkMerge 11F 10F (translate 1F 0F (0F ∷ []) 0)
              ∷ [] )
            ∷ []
          ...
          ∷ ( ( mkMerge 10F 0F (seed 0)
              ...
              ∷ mkMerge 7F 8F (translate 1F 0F (0F ∷ []) 2)
            ...
            ∷ ( mkMerge 10F 1F (seed 0)
              ...
              ∷ mkMerge 5F 8F (translate 1F 0F (0F ∷ []) 4)
            ...
            ∷ ( mkMerge 10F 2F (seed 0)
              ...
              ∷ mkMerge 0F 5F (translate 2F 0F (0F ∷ []) 4)
              ∷ mkMerge 11F 1F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 5F 9F (translate 1F 0F (0F ∷ []) 4)
            ...
            ∷ ( mkMerge 10F 11F (seed 0)
              ...
              ∷ mkMerge 7F 5F (translate 1F 0F (0F ∷ []) 1)
              ∷ mkMerge 4F 6F (translate 1F 0F (0F ∷ []) 1)
              ∷ mkMerge 8F 9F (translate 1F 0F (0F ∷ []) 0)
              ∷ [] )
            ∷ [] )
          ∷ ( ( mkMerge 11F 0F (seed 0)
              ...
              ∷ mkMerge 4F 9F (translate 0F 0F (0F ∷ []) 3)
              ∷ [] )
            ...
            ∷ ( mkMerge 11F 2F (seed 0)
              ...
              ∷ mkMerge 10F 0F (translate 2F 0F (0F ∷ []) 2)
              ∷ mkMerge 1F 6F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 3F 4F (translate 0F 0F (0F ∷ []) 2)
              ∷ mkMerge 0F 5F (translate 2F 0F (0F ∷ []) 3)
              ∷ mkMerge 11F 1F (translate 0F 0F (0F ∷ []) 3)
              ∷ mkMerge 0F 7F (translate 0F 0F (0F ∷ []) 3)
            ...
            ∷ ( mkMerge 11F 3F (seed 0)
              ...
              ∷ mkMerge 5F 9F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 0F 5F (translate 2F 0F (0F ∷ []) 4)
              ∷ mkMerge 11F 1F (translate 0F 0F (0F ∷ []) 4)
              ∷ mkMerge 1F 4F (translate 1F 0F (0F ∷ []) 5)
              ∷ mkMerge 4F 8F (translate 0F 0F (0F ∷ []) 3)
              ∷ [] )
            ...
            ∷ ( mkMerge 11F 5F (seed 0)
              ...
              ∷ mkMerge 0F 10F (translate 2F 0F (0F ∷ []) 3)
              ∷ mkMerge 1F 11F (translate 1F 0F (0F ∷ []) 3)
              ∷ mkMerge 0F 9F (translate 0F 0F (0F ∷ []) 3)
            ...
            ∷ ( mkMerge 11F 6F (seed 0)
              ...
              ∷ mkMerge 10F 5F (translate 2F 0F (0F ∷ []) 2)
              ∷ mkMerge 1F 10F (translate 1F 0F (0F ∷ []) 2)
            ...
            ∷ ( mkMerge 11F 7F (seed 0)
              ...
              ∷ mkMerge 10F 5F (translate 2F 0F (0F ∷ []) 2)
              ∷ mkMerge 1F 9F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 3F 11F (translate 0F 0F (0F ∷ []) 2)
            ...
            ∷ ( mkMerge 11F 10F (seed 0)
              ...
              ∷ mkMerge 5F 7F (translate 1F 0F (0F ∷ []) 1)
              ∷ mkMerge 6F 4F (translate 1F 0F (0F ∷ []) 1)
              ∷ mkMerge 9F 8F (translate 1F 0F (0F ∷ []) 0)
              ∷ [] )
            ∷ []
            ∷ [] )
          ∷ []

  joinTrᵛ : Vec (Vec (Trace 12 3 arOf) 7) 7
  joinTrᵛ = ( []
            ∷ ( mkMerge 1F 0F (seed 0)
              ∷ mkMerge 3F 2F (seed 1)
              ∷ mkMerge 6F 5F (seed 2)
              ∷ mkMerge 7F 4F (seed 3)
              ∷ mkMerge 10F 8F (seed 4)
              ∷ mkMerge 11F 9F (seed 5)
              ∷ [] )
            ∷ ( mkMerge 2F 0F (seed 0)
              ∷ mkMerge 3F 1F (seed 1)
              ∷ mkMerge 5F 4F (seed 2)
              ∷ mkMerge 7F 6F (seed 3)
              ∷ mkMerge 10F 9F (seed 4)
              ∷ mkMerge 11F 8F (seed 5)
              ∷ [] )
            ∷ ( mkMerge 2F 1F (seed 0)
              ∷ mkMerge 3F 0F (seed 1)
              ∷ mkMerge 6F 4F (seed 2)
              ∷ mkMerge 7F 5F (seed 3)
              ∷ mkMerge 9F 8F (seed 4)
              ∷ mkMerge 11F 10F (seed 5)
              ∷ [] )
            ∷ ( mkMerge 4F 1F (seed 0)
          ...
          ∷ ( ( mkMerge 1F 0F (seed 0)
            ...
            ∷ ( mkMerge 1F 0F (seed 0)
              ...
              ∷ mkMerge 5F 4F (seed 8)
              ∷ mkMerge 10F 9F (seed 10)
              ∷ [] )
            ∷ ( mkMerge 1F 0F (seed 0)
              ∷ mkMerge 3F 2F (seed 1)
              ∷ mkMerge 6F 5F (seed 2)
              ...
              ∷ mkMerge 10F 8F (seed 4)
              ∷ mkMerge 11F 9F (seed 5)
              ∷ mkMerge 2F 1F (seed 6)
              ∷ mkMerge 6F 4F (seed 8)
            ...
            ∷ ( mkMerge 1F 0F (seed 0)
              ...
              ∷ mkMerge 10F 8F (seed 4)
              ∷ mkMerge 11F 9F (seed 5)
              ∷ mkMerge 4F 1F (seed 6)
              ∷ mkMerge 5F 0F (seed 7)
              ∷ mkMerge 6F 3F (seed 8)
              ∷ mkMerge 8F 2F (seed 10)
              ∷ mkMerge 9F 3F (seed 11)
              ∷ [] )
            ∷ ( mkMerge 1F 0F (seed 0)
              ∷ mkMerge 3F 2F (seed 1)
              ∷ mkMerge 6F 5F (seed 2)
          ...
          ∷ ( ( mkMerge 2F 0F (seed 0)
            ...
            ∷ ( mkMerge 2F 0F (seed 0)
              ...
              ∷ mkMerge 6F 5F (seed 8)
              ∷ mkMerge 10F 8F (seed 10)
              ∷ [] )
            ∷ ( mkMerge 2F 0F (seed 0)
              ∷ mkMerge 3F 1F (seed 1)
              ∷ mkMerge 5F 4F (seed 2)
          ...
          ∷ ( ( mkMerge 4F 1F (seed 0)
            ...
            ∷ ( mkMerge 4F 1F (seed 0)
              ...
              ∷ mkMerge 10F 0F (seed 6)
              ∷ mkMerge 11F 1F (seed 7)
              ∷ mkMerge 1F 0F (seed 8)
              ∷ mkMerge 3F 2F (seed 9)
              ∷ mkMerge 6F 5F (seed 10)
              ∷ [] )
            ∷ ( mkMerge 4F 1F (seed 0)
              ∷ mkMerge 5F 0F (seed 1)
              ∷ mkMerge 6F 3F (seed 2)
              ...
              ∷ mkMerge 10F 0F (seed 6)
              ∷ mkMerge 11F 1F (seed 7)
              ∷ mkMerge 2F 0F (seed 8)
              ∷ mkMerge 3F 1F (seed 9)
              ∷ mkMerge 5F 4F (seed 10)
              ∷ [] )
            ∷ ( mkMerge 4F 1F (seed 0)
              ∷ mkMerge 5F 0F (seed 1)
              ∷ mkMerge 6F 3F (seed 2)
...
```agda
SLR17-Representableᵈ : Representableᵈ (toLattice 𝑳)
SLR17-Representableᵈ = certRepresentableᵈ 𝑭 𝑺 𝑳 cert certOK certMeet

SLR17-FiniteCongruencesᵈ : FiniteCongruencesᵈ 𝑨
SLR17-FiniteCongruencesᵈ = certFiniteCongruencesᵈ cert certOK
```
