---
layout: default
file: "src/FLRP/Certificates/SmallLatticeReps/SLR05.lagda.md"
title: "FLRP.Certificates.SmallLatticeReps.SLR05 module (The Agda Universal Algebra Library)"
date: "2026-07-22"
...
`scripts/python/flrp/inputs/slr/slr05.json`.  Do not edit it by hand; rerun the emitter instead.**
...
claim that the congruence lattice of the algebra "B5" — carrier size
12, unary operations `f`, `g`, `h` — is isomorphic to the lattice
"manuscript L5" (6 elements).  The engine's output below (normal-form
...
The claimed congruence lattice "manuscript L5", presented exactly as the
