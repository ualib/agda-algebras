---
layout: default
file: "src/FLRP/Certificates/SmallLatticeReps/SLR19.lagda.md"
title: "FLRP.Certificates.SmallLatticeReps.SLR19 module (The Agda Universal Algebra Library)"
date: "2026-07-22"
author: "the agda-algebras development team (emitted by scripts/python/flrp)"
---

### A machine-checked representation: Con(B19) ≅ manuscript L19

This is the [FLRP.Certificates.SmallLatticeReps.SLR19][] module of the [Agda Universal Algebra Library][].

**This module was emitted by `scripts/python/flrp/emit_agda.py` from
`scripts/python/flrp/inputs/slr/slr19.json`.  Do not edit it by hand; rerun the emitter instead.**

`B19`/`L19` in the numbering of the DeMeo–Freese–Jipsen manuscript *Representing Finite Lattices as Congruence Lattices of Finite Algebras* (§ 6 of the 2016-06-10 draft, `docs/papers/fin-lat-rep/SmallLatticeReps.tex`).  The dictionary between the manuscript's lattice numbering and this library's names is `docs/notes/flrp-slr-naming.md`.

It re-verifies, end-to-end through the WP-6 certificate pipeline (#457), the
claim that the congruence lattice of the algebra "B19" — carrier size
8, unary operations `f`, `g`, `h` — is isomorphic to the lattice
"manuscript L19" (7 elements).  The engine's output below (normal-form
...
module FLRP.Certificates.SmallLatticeReps.SLR19 where
...
```agda
opTables : Vec (Vec (Fin 8) 8) 3
opTables = (0F ∷ 1F ∷ 1F ∷ 0F ∷ 4F ∷ 5F ∷ 5F ∷ 4F ∷ [])
         ∷ (0F ∷ 2F ∷ 3F ∷ 1F ∷ 0F ∷ 2F ∷ 3F ∷ 1F ∷ [])
         ∷ (7F ∷ 6F ∷ 6F ∷ 7F ∷ 3F ∷ 2F ∷ 2F ∷ 3F ∷ [])
         ∷ []

𝑨 : Algebra {𝑆 = Sig-Unary (Fin 3)} 0ℓ 0ℓ
𝑨 = tablesToUnaryAlgebra 8 3 opTables

𝑭 : FiniteAlgebra 𝑨
𝑭 = tablesToUnaryAlgebra-FiniteAlgebra 8 3 opTables
...
The claimed congruence lattice "manuscript L19", presented exactly as the
...
cert : LatticeCert 8 3 arOf 7
cert = mkLatticeCert partsᵛ 0F prinᵛ prinTrᵛ ∧-table ∨-table joinTrᵛ
  where
  partsᵛ : Vec (ParentVec 8) 7
  partsᵛ = (0F ∷ 1F ∷ 2F ∷ 3F ∷ 4F ∷ 5F ∷ 6F ∷ 7F ∷ [])
         ∷ (0F ∷ 0F ∷ 0F ∷ 0F ∷ 4F ∷ 4F ∷ 6F ∷ 6F ∷ [])
         ∷ (0F ∷ 1F ∷ 2F ∷ 3F ∷ 0F ∷ 5F ∷ 6F ∷ 3F ∷ [])
         ∷ (0F ∷ 1F ∷ 2F ∷ 3F ∷ 4F ∷ 1F ∷ 2F ∷ 7F ∷ [])
         ∷ (0F ∷ 0F ∷ 0F ∷ 0F ∷ 4F ∷ 4F ∷ 4F ∷ 4F ∷ [])
         ∷ (0F ∷ 1F ∷ 2F ∷ 3F ∷ 0F ∷ 1F ∷ 2F ∷ 3F ∷ [])
         ∷ (0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ 0F ∷ [])
         ∷ []

  prinᵛ : Vec (Vec (Fin 7) 8) 8
  prinᵛ = (0F ∷ 1F ∷ 1F ∷ 1F ∷ 2F ∷ 6F ∷ 6F ∷ 6F ∷ [])
        ∷ (1F ∷ 0F ∷ 1F ∷ 1F ∷ 6F ∷ 3F ∷ 6F ∷ 6F ∷ [])
        ∷ (1F ∷ 1F ∷ 0F ∷ 1F ∷ 6F ∷ 6F ∷ 3F ∷ 6F ∷ [])
        ∷ (1F ∷ 1F ∷ 1F ∷ 0F ∷ 6F ∷ 6F ∷ 6F ∷ 2F ∷ [])
        ∷ (2F ∷ 6F ∷ 6F ∷ 6F ∷ 0F ∷ 1F ∷ 4F ∷ 4F ∷ [])
        ∷ (6F ∷ 3F ∷ 6F ∷ 6F ∷ 1F ∷ 0F ∷ 4F ∷ 4F ∷ [])
        ∷ (6F ∷ 6F ∷ 3F ∷ 6F ∷ 4F ∷ 4F ∷ 0F ∷ 1F ∷ [])
        ∷ (6F ∷ 6F ∷ 6F ∷ 2F ∷ 4F ∷ 4F ∷ 1F ∷ 0F ∷ [])
        ∷ []

  prinTrᵛ : Vec (Vec (Trace 8 3 arOf) 8) 8
  prinTrᵛ = ( []
            ∷ ( mkMerge 0F 1F (seed 0)
              ∷ mkMerge 0F 2F (translate 1F 0F (0F ∷ []) 0)
              ∷ mkMerge 7F 6F (translate 2F 0F (0F ∷ []) 1)
            ...
            ∷ ( mkMerge 0F 4F (seed 0)
              ∷ mkMerge 7F 3F (translate 2F 0F (0F ∷ []) 0)
              ∷ [] )
            ∷ ( mkMerge 0F 5F (seed 0)
              ∷ mkMerge 0F 2F (translate 1F 0F (0F ∷ []) 0)
              ∷ mkMerge 7F 2F (translate 2F 0F (0F ∷ []) 1)
              ∷ mkMerge 0F 1F (translate 0F 0F (0F ∷ []) 1)
              ∷ mkMerge 0F 3F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 7F 6F (translate 2F 0F (0F ∷ []) 3)
          ...
          ∷ ( ( mkMerge 1F 0F (seed 0)
              ...
              ∷ mkMerge 6F 7F (translate 2F 0F (0F ∷ []) 1)
            ...
            ∷ ( mkMerge 1F 4F (seed 0)
              ∷ mkMerge 2F 0F (translate 1F 0F (0F ∷ []) 0)
              ∷ mkMerge 6F 3F (translate 2F 0F (0F ∷ []) 1)
              ∷ mkMerge 1F 0F (translate 0F 0F (0F ∷ []) 1)
              ∷ mkMerge 3F 0F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 6F 7F (translate 2F 0F (0F ∷ []) 3)
            ...
            ∷ ( mkMerge 1F 7F (seed 0)
              ...
              ∷ mkMerge 3F 2F (translate 1F 0F (0F ∷ []) 2)
          ...
          ∷ ( ( mkMerge 4F 0F (seed 0)
              ∷ mkMerge 3F 7F (translate 2F 0F (0F ∷ []) 0)
              ∷ [] )
            ∷ ( mkMerge 4F 1F (seed 0)
              ∷ mkMerge 0F 2F (translate 1F 0F (0F ∷ []) 0)
              ∷ mkMerge 3F 6F (translate 2F 0F (0F ∷ []) 1)
              ∷ mkMerge 0F 1F (translate 0F 0F (0F ∷ []) 1)
              ∷ mkMerge 0F 3F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 7F 6F (translate 2F 0F (0F ∷ []) 3)
          ...
          ∷ ( ( mkMerge 5F 0F (seed 0)
              ∷ mkMerge 2F 0F (translate 1F 0F (0F ∷ []) 0)
              ∷ mkMerge 2F 7F (translate 2F 0F (0F ∷ []) 1)
              ∷ mkMerge 1F 0F (translate 0F 0F (0F ∷ []) 1)
              ∷ mkMerge 3F 0F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 6F 7F (translate 2F 0F (0F ∷ []) 3)
          ...
          ∷ ( ( mkMerge 7F 0F (seed 0)
            ...
            ∷ ( mkMerge 7F 1F (seed 0)
              ...
              ∷ mkMerge 3F 6F (translate 2F 0F (0F ∷ []) 2)
              ∷ mkMerge 0F 2F (translate 1F 0F (0F ∷ []) 2)
              ∷ mkMerge 2F 3F (translate 1F 0F (0F ∷ []) 2)
  ...
  joinTrᵛ : Vec (Vec (Trace 8 3 arOf) 7) 7
  joinTrᵛ = ( []
            ∷ ( mkMerge 1F 0F (seed 0)
              ∷ mkMerge 2F 0F (seed 1)
              ∷ mkMerge 3F 0F (seed 2)
              ∷ mkMerge 5F 4F (seed 3)
              ∷ mkMerge 7F 6F (seed 4)
              ∷ [] )
            ∷ ( mkMerge 4F 0F (seed 0)
              ∷ mkMerge 7F 3F (seed 1)
              ∷ [] )
            ∷ ( mkMerge 5F 1F (seed 0)
              ∷ mkMerge 6F 2F (seed 1)
              ∷ [] )
            ∷ ( mkMerge 1F 0F (seed 0)
              ∷ mkMerge 2F 0F (seed 1)
              ∷ mkMerge 3F 0F (seed 2)
          ...
          ∷ ( ( mkMerge 4F 0F (seed 0)
            ...
            ∷ ( mkMerge 4F 0F (seed 0)
              ...
              ∷ mkMerge 3F 0F (seed 4)
              ∷ mkMerge 5F 4F (seed 5)
              ∷ mkMerge 6F 4F (seed 6)
              ∷ [] )
            ∷ ( mkMerge 4F 0F (seed 0)
              ∷ mkMerge 7F 3F (seed 1)
              ∷ mkMerge 5F 1F (seed 3)
              ∷ mkMerge 6F 2F (seed 4)
              ∷ [] )
            ∷ ( mkMerge 4F 0F (seed 0)
              ∷ mkMerge 7F 3F (seed 1)
              ∷ mkMerge 1F 0F (seed 2)
          ...
          ∷ ( ( mkMerge 5F 1F (seed 0)
            ...
            ∷ ( mkMerge 5F 1F (seed 0)
              ...
              ∷ mkMerge 3F 0F (seed 4)
              ∷ mkMerge 5F 4F (seed 5)
              ∷ mkMerge 7F 4F (seed 7)
              ∷ [] )
            ∷ ( mkMerge 5F 1F (seed 0)
              ∷ mkMerge 6F 2F (seed 1)
              ∷ mkMerge 4F 0F (seed 2)
              ∷ mkMerge 7F 3F (seed 5)
              ∷ [] )
            ∷ ( mkMerge 5F 1F (seed 0)
              ∷ mkMerge 6F 2F (seed 1)
              ∷ mkMerge 1F 0F (seed 2)
...
```agda
SLR19-Representableᵈ : Representableᵈ (toLattice 𝑳)
SLR19-Representableᵈ = certRepresentableᵈ 𝑭 𝑺 𝑳 cert certOK certMeet

SLR19-FiniteCongruencesᵈ : FiniteCongruencesᵈ 𝑨
SLR19-FiniteCongruencesᵈ = certFiniteCongruencesᵈ cert certOK
```
