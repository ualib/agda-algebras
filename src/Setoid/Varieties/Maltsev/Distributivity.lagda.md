...
development — the Day terms and the complete iff `Day-theorem`, whose forward half runs
a genuinely different ladder — lives in [Setoid.Varieties.Maltsev.Modularity][] and the
design note.
