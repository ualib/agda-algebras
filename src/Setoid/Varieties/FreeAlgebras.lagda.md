...
the step the theorem turns on: every model of the theory of `V 𝒦` is a
homomorphic image of `𝔽[ X ]`.  See [Setoid.Varieties.HSP][] for the argument
these pieces are assembled into.
