...
open import Classical.Properties.Lattice        using ( Absorbsˡ? ; Absorbsʳ? ; module FiniteOrder )
...
generic `Overture.Cayley` deciders; the two absorption laws come from
`Classical.Properties.Lattice` (`Absorbsˡ?`, `Absorbsʳ?`).
