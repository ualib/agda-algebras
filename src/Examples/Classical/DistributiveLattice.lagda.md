---
layout: default
file: "src/Examples/Classical/DistributiveLattice.lagda.md"
title: "Examples.Classical.DistributiveLattice module"
date: "2026-05-31"
author: "the agda-algebras development team"
---

### Worked example — `𝟚 = (Bool, _∧_, _∨_)` as a distributive lattice {#examples-classical-distributivelattice}
...
round-trips through stdlib's `Algebra.Lattice.Bundles.DistributiveLattice`.
...
module Examples.Classical.DistributiveLattice where
