...
open import Overture.Setoid.Inverses                  using ( Image_∋_ )
open import Relations.Discrete                        using ( kerRel ; kerRelOfEquiv )
open import Algebras.Setoid.Basic            {𝑆 = 𝑆}  using ( Algebra ; _̂_ ; ov )
open import Algebras.Setoid.Congruences      {𝑆 = 𝑆}  using ( _∣≈_ ; Con ; mkcon ; _╱_ ; IsCongruence )
open import Homomorphisms.Setoid.Basic       {𝑆 = 𝑆}  using ( hom ; IsHom ; epi ; IsEpi ; epi→hom )
open import Homomorphisms.Setoid.Properties  {𝑆 = 𝑆}  using ( 𝒾𝒹 )
...
<span style="float:right;">[Homomorphisms.Setoid.Products →](Homomorphisms.Setoid.Products.html)</span>
