...
open import Algebras.Setoid.Basic                  using ( Algebra ; _̂_)
open import Homomorphisms.Setoid.Basic    {𝑆 = 𝑆}  using ( hom ; IsHom )
open import Homomorphisms.Setoid.Kernels  {𝑆 = 𝑆}  using ( kerquo ; πker )
...
<span style="float:left;">[← Homomorphisms.Setoid.Products](Homomorphisms.Setoid.Products.html)</span>
