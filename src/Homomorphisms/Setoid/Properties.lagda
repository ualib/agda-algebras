...
open import Overture.Setoid.Preliminaries      using ( _∘_ ; 𝑖𝑑 )
open import Overture.Setoid.Inverses           using ( Image_∋_ ; eq )
open import Overture.Setoid.Surjective         using ( ∘-IsSurjective )
open import Algebras.Setoid.Basic      {𝑆 = 𝑆} using ( Algebra ; _̂_ ; Lift-Algˡ
                                                   ; Lift-Algʳ ; Lift-Alg ; 𝕌[_] )
open import Homomorphisms.Setoid.Basic {𝑆 = 𝑆} using ( hom ; IsHom ; epi ; IsEpi ; compatible-map )
