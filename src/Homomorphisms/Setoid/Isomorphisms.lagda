...
open import Overture.Setoid.Preliminaries             using ( _∘_ )
...
open import Algebras.Setoid.Basic            {𝑆 = 𝑆}  using ( Algebra ; Lift-Alg ; _̂_)
...
open import Homomorphisms.Setoid.Properties  {𝑆 = 𝑆}  using ( 𝒾𝒹 ; ∘-hom ; ToLiftˡ ; FromLiftˡ )
...
<span style="float:left;">[← Homomorphisms.Setoid.Factor](Homomorphisms.Setoid.Factor.html)</span>
