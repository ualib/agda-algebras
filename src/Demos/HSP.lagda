...
constructive.\footnote{See the \href{https://github.com/ualib/ualib.github.io/blob/71f173858701398d56224dd79d152c380c0c2b5e/src/lagda/UALib/Birkhoff.lagda}{Birkhoff} module
from the
\href{https://github.com/ualib/ualib.github.io/commit/71f173858701398d56224dd79d152c380c0c2b5e}{15 Jan 2021 commit (71f1738)} of the \href{https://github.com/ualib/ualib.github.io}{ualib/ualib.gitlab.io} repository~\cite{ualib_v1.0.0}.}
We are confident that the version we present here---based on version 2.0.0 of the
\agdaalgebras library---is fully constructive and correct.\footnote{Specifically, see the \href{https://github.com/ualib/agda-algebras/commit/ab859caf814566fe32205f76bd0a4ac1e6007147}{30 Nov 2021 commit (ab859ca)} of the \agdaalgebras library~\cite{ualib_v2.0.0}.}
To the best of our knowledge, ours is the first formulation of the HSP theorem in MLTT, and the
first formal, machine-verified proof of Birkhoff's celebrated 1935 result.

In this paper, we present a self-contained formal proof of the HSP theorem by
extracting into a single Agda module a subset of the \agdaalgebras library, including only
the pieces we need for the proof.  The main body of the paper is generated by a literate
Agda file, available online,\footnote{See
\url{https://github.com/ualib/agda-algebras/blob/master/src/Demos/HSP.lagda}}
that others can type-check, using \agda version 2.6.2 and \agdastdlib version 1.7, to
...
details, we have posted on the arXiv an unabridged version of the paper, which presents
every line of code of the proof of Birkhoff's theorem in a single Agda module~\cite{DeMeo:2021}
and which, apart from a few dozen imports from the \agdastdlib, is self-contained.
\else
...
axiom} asserts that two point-wise equal functions are equal. There remain some modules in the \agdaalgebras library that
occasionally postulate this axiom, but we don't make use of the axiom here.}
