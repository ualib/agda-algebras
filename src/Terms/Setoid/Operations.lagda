---
layout: default
title : "Terms.Setoid.Operations module (The Agda Universal Algebra Library)"
date : "2021-09-25"
...
This section presents the [Terms.Setoid.Operations][] module of the [Agda Universal Algebra Library][].
...
module Terms.Setoid.Operations {𝑆 : Signature 𝓞 𝓥} where
...
open import Terms.Setoid.Basic          {𝑆 = 𝑆}  using ( module Environment ; 𝑻 ; _≐_ ; ≐-isRefl )
