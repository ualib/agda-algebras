...
Now we are ready to prove that the intersection of subuniverses is a subuniverse.
...
Next we formalize the proof of the obvious fact that a subuniverse containing ``X`` also contains the subuniverse generated by ``X``, and immediately thereafter we check that :math:`\operatorname{Sg}^𝐀 (X)` is, indeed, a subuniverse.
