...
<a id="14635" class="Keyword">module</a> <a id="14642" href="Prelude.Preliminaries.html#14642" class="Module">_</a> <a id="14644" class="Symbol">{</a><a id="14645" href="Prelude.Preliminaries.html#14645" class="Bound">𝓨</a> <a id="14647" href="Prelude.Preliminaries.html#14647" class="Bound">𝓩</a> <a id="14649" class="Symbol">:</a> <a id="14651" href="Agda.Primitive.html#423" class="Postulate">Universe</a><a id="14659" class="Symbol">}{</a><a id="14661" href="Prelude.Preliminaries.html#14661" class="Bound">I</a> <a id="14663" class="Symbol">:</a> <a id="14665" href="Universes.html#262" class="Generalizable">𝓥</a> <a id="14667" href="Universes.html#403" class="Function Operator">̇</a><a id="14668" class="Symbol">}{</a><a id="14670" href="Prelude.Preliminaries.html#14670" class="Bound">B</a> <a id="14672" class="Symbol">:</a> <a id="14674" href="Prelude.Preliminaries.html#14661" class="Bound">I</a> <a id="14676" class="Symbol">→</a> <a id="14678" href="Prelude.Preliminaries.html#14645" class="Bound">𝓨</a> <a id="14680" href="Universes.html#403" class="Function Operator">̇</a><a id="14681" class="Symbol">}{</a><a id="14683" href="Prelude.Preliminaries.html#14683" class="Bound">C</a> <a id="14685" class="Symbol">:</a> <a id="14687" href="Prelude.Preliminaries.html#14661" class="Bound">I</a> <a id="14689" class="Symbol">→</a> <a id="14691" href="Prelude.Preliminaries.html#14647" class="Bound">𝓩</a> <a id="14693" href="Universes.html#403" class="Function Operator">̇</a><a id="14694" class="Symbol">}</a> <a id="14696" class="Keyword">where</a>
 ...
 <a id="14726" href="Prelude.Preliminaries.html#14726" class="Function">fork</a> <a id="14731" class="Symbol">:</a> <a id="14733" href="MGS-MLTT.html#3562" class="Function">Π</a> <a id="14735" href="Prelude.Preliminaries.html#14670" class="Bound">B</a> <a id="14737" class="Symbol">→</a> <a id="14739" href="MGS-MLTT.html#3562" class="Function">Π</a> <a id="14741" href="Prelude.Preliminaries.html#14683" class="Bound">C</a> <a id="14743" class="Symbol">→</a> <a id="14745" href="MGS-MLTT.html#3562" class="Function">Π</a> <a id="14747" class="Symbol">(λ</a> <a id="14750" href="Prelude.Preliminaries.html#14750" class="Bound">i</a> <a id="14752" class="Symbol">→</a> <a id="14754" class="Symbol">(</a><a id="14755" href="Prelude.Preliminaries.html#14670" class="Bound">B</a> <a id="14757" href="Prelude.Preliminaries.html#14750" class="Bound">i</a><a id="14758" class="Symbol">)</a> <a id="14760" href="MGS-MLTT.html#3515" class="Function Operator">×</a> <a id="14762" class="Symbol">(</a><a id="14763" href="Prelude.Preliminaries.html#14683" class="Bound">C</a> <a id="14765" href="Prelude.Preliminaries.html#14750" class="Bound">i</a><a id="14766" class="Symbol">))</a>
 <a id="14770" href="Prelude.Preliminaries.html#14726" class="Function">fork</a> <a id="14775" href="Prelude.Preliminaries.html#14775" class="Bound">f</a> <a id="14777" href="Prelude.Preliminaries.html#14777" class="Bound">a</a> <a id="14779" class="Symbol">=</a> <a id="14781" class="Symbol">λ</a> <a id="14783" href="Prelude.Preliminaries.html#14783" class="Bound">i</a> <a id="14785" class="Symbol">→</a> <a id="14787" class="Symbol">(</a><a id="14788" href="Prelude.Preliminaries.html#14775" class="Bound">f</a> <a id="14790" href="Prelude.Preliminaries.html#14783" class="Bound">i</a> <a id="14792" href="Prelude.Preliminaries.html#13052" class="InductiveConstructor Operator">,</a> <a id="14794" href="Prelude.Preliminaries.html#14777" class="Bound">a</a> <a id="14796" href="Prelude.Preliminaries.html#14783" class="Bound">i</a><a id="14797" class="Symbol">)</a>

 <a id="14801" href="Prelude.Preliminaries.html#14801" class="Function">eval</a> <a id="14806" class="Symbol">:</a> <a id="14808" class="Symbol">{</a><a id="14809" href="Prelude.Preliminaries.html#14809" class="Bound">Y</a> <a id="14811" class="Symbol">:</a> <a id="14813" href="Prelude.Preliminaries.html#14645" class="Bound">𝓨</a> <a id="14815" href="Universes.html#403" class="Function Operator">̇</a><a id="14816" class="Symbol">}{</a><a id="14818" href="Prelude.Preliminaries.html#14818" class="Bound">Z</a> <a id="14820" class="Symbol">:</a> <a id="14822" href="Prelude.Preliminaries.html#14647" class="Bound">𝓩</a> <a id="14824" href="Universes.html#403" class="Function Operator">̇</a><a id="14825" class="Symbol">}</a> <a id="14827" class="Symbol">→</a> <a id="14829" class="Symbol">((</a><a id="14831" href="Prelude.Preliminaries.html#14809" class="Bound">Y</a> <a id="14833" class="Symbol">→</a> <a id="14835" href="Prelude.Preliminaries.html#14818" class="Bound">Z</a><a id="14836" class="Symbol">)</a> <a id="14838" href="MGS-MLTT.html#3515" class="Function Operator">×</a> <a id="14840" href="Prelude.Preliminaries.html#14809" class="Bound">Y</a><a id="14841" class="Symbol">)</a> <a id="14843" class="Symbol">→</a> <a id="14845" href="Prelude.Preliminaries.html#14818" class="Bound">Z</a>
 <a id="14848" href="Prelude.Preliminaries.html#14801" class="Function">eval</a> <a id="14853" class="Symbol">(</a><a id="14854" href="Prelude.Preliminaries.html#14854" class="Bound">f</a> <a id="14856" href="Prelude.Preliminaries.html#13052" class="InductiveConstructor Operator">,</a> <a id="14858" href="Prelude.Preliminaries.html#14858" class="Bound">a</a><a id="14859" class="Symbol">)</a> <a id="14861" class="Symbol">=</a> <a id="14863" href="Prelude.Preliminaries.html#14854" class="Bound">f</a> <a id="14865" href="Prelude.Preliminaries.html#14858" class="Bound">a</a>
 
<a id="14869" class="Keyword">module</a> <a id="14876" href="Prelude.Preliminaries.html#14876" class="Module">_</a> <a id="14878" class="Symbol">{</a><a id="14879" href="Prelude.Preliminaries.html#14879" class="Bound">𝓨</a> <a id="14881" class="Symbol">:</a> <a id="14883" href="Agda.Primitive.html#423" class="Postulate">Universe</a><a id="14891" class="Symbol">}{</a><a id="14893" href="Prelude.Preliminaries.html#14893" class="Bound">I</a> <a id="14895" href="Prelude.Preliminaries.html#14895" class="Bound">J</a> <a id="14897" class="Symbol">:</a> <a id="14899" href="Universes.html#262" class="Generalizable">𝓥</a> <a id="14901" href="Universes.html#403" class="Function Operator">̇</a><a id="14902" class="Symbol">}{</a><a id="14904" href="Prelude.Preliminaries.html#14904" class="Bound">B</a> <a id="14906" class="Symbol">:</a> <a id="14908" href="Prelude.Preliminaries.html#14893" class="Bound">I</a> <a id="14910" class="Symbol">→</a> <a id="14912" href="Prelude.Preliminaries.html#14879" class="Bound">𝓨</a> <a id="14914" href="Universes.html#403" class="Function Operator">̇</a><a id="14915" class="Symbol">}</a> <a id="14917" class="Keyword">where</a>

 <a id="14925" href="Prelude.Preliminaries.html#14925" class="Function">dapp</a> <a id="14930" class="Symbol">:</a> <a id="14932" class="Symbol">(∀</a> <a id="14935" href="Prelude.Preliminaries.html#14935" class="Bound">i</a> <a id="14937" class="Symbol">→</a> <a id="14939" class="Symbol">(</a><a id="14940" href="Prelude.Preliminaries.html#14895" class="Bound">J</a> <a id="14942" class="Symbol">→</a> <a id="14944" class="Symbol">(</a><a id="14945" href="Prelude.Preliminaries.html#14904" class="Bound">B</a> <a id="14947" href="Prelude.Preliminaries.html#14935" class="Bound">i</a><a id="14948" class="Symbol">))</a> <a id="14951" class="Symbol">→</a> <a id="14953" class="Symbol">(</a><a id="14954" href="Prelude.Preliminaries.html#14904" class="Bound">B</a> <a id="14956" href="Prelude.Preliminaries.html#14935" class="Bound">i</a><a id="14957" class="Symbol">))</a> <a id="14960" class="Symbol">→</a> <a id="14962" class="Symbol">(∀</a> <a id="14965" href="Prelude.Preliminaries.html#14965" class="Bound">i</a> <a id="14967" class="Symbol">→</a> <a id="14969" class="Symbol">(</a><a id="14970" href="Prelude.Preliminaries.html#14895" class="Bound">J</a> <a id="14972" class="Symbol">→</a> <a id="14974" class="Symbol">(</a><a id="14975" href="Prelude.Preliminaries.html#14904" class="Bound">B</a> <a id="14977" href="Prelude.Preliminaries.html#14965" class="Bound">i</a><a id="14978" class="Symbol">)))</a> <a id="14982" class="Symbol">→</a> <a id="14984" href="MGS-MLTT.html#3562" class="Function">Π</a> <a id="14986" href="Prelude.Preliminaries.html#14904" class="Bound">B</a>
 <a id="14989" href="Prelude.Preliminaries.html#14925" class="Function">dapp</a> <a id="14994" href="Prelude.Preliminaries.html#14994" class="Bound">f</a> <a id="14996" href="Prelude.Preliminaries.html#14996" class="Bound">a</a> <a id="14998" class="Symbol">=</a> <a id="15000" class="Symbol">λ</a> <a id="15002" href="Prelude.Preliminaries.html#15002" class="Bound">i</a> <a id="15004" class="Symbol">→</a> <a id="15006" class="Symbol">(</a><a id="15007" href="Prelude.Preliminaries.html#14994" class="Bound">f</a> <a id="15009" href="Prelude.Preliminaries.html#15002" class="Bound">i</a><a id="15010" class="Symbol">)</a> <a id="15012" class="Symbol">(</a><a id="15013" href="Prelude.Preliminaries.html#14996" class="Bound">a</a> <a id="15015" href="Prelude.Preliminaries.html#15002" class="Bound">i</a><a id="15016" class="Symbol">)</a>
