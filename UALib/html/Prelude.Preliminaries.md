...
<a id="12348" class="Keyword">module</a> <a id="12355" href="Prelude.Preliminaries.html#12355" class="Module">_</a> <a id="12357" class="Symbol">{</a><a id="12358" href="Prelude.Preliminaries.html#12358" class="Bound">𝓤</a> <a id="12360" class="Symbol">:</a> <a id="12362" href="Agda.Primitive.html#423" class="Postulate">Universe</a><a id="12370" class="Symbol">}{</a><a id="12372" href="Prelude.Preliminaries.html#12372" class="Bound">A</a> <a id="12374" class="Symbol">:</a> <a id="12376" href="Prelude.Preliminaries.html#12358" class="Bound">𝓤</a> <a id="12378" href="Universes.html#403" class="Function Operator">̇</a> <a id="12380" class="Symbol">}{</a><a id="12382" href="Prelude.Preliminaries.html#12382" class="Bound">B</a> <a id="12384" class="Symbol">:</a> <a id="12386" href="Prelude.Preliminaries.html#12372" class="Bound">A</a> <a id="12388" class="Symbol">→</a> <a id="12390" href="Universes.html#262" class="Generalizable">𝓥</a> <a id="12392" href="Universes.html#403" class="Function Operator">̇</a><a id="12393" class="Symbol">}</a> <a id="12395" class="Keyword">where</a>

 <a id="12403" href="Prelude.Preliminaries.html#12403" class="Function Operator">∣_∣</a> <a id="12407" href="Prelude.Preliminaries.html#12407" class="Function">fst</a> <a id="12411" class="Symbol">:</a> <a id="12413" href="Sigma-Type.html#120" class="Record">Σ</a> <a id="12415" href="Prelude.Preliminaries.html#12382" class="Bound">B</a> <a id="12417" class="Symbol">→</a> <a id="12419" href="Prelude.Preliminaries.html#12372" class="Bound">A</a>
 <a id="12422" href="Prelude.Preliminaries.html#12403" class="Function Operator">∣</a> <a id="12424" href="Prelude.Preliminaries.html#12424" class="Bound">x</a> <a id="12426" href="Prelude.Preliminaries.html#11707" class="InductiveConstructor Operator">,</a> <a id="12428" href="Prelude.Preliminaries.html#12428" class="Bound">y</a> <a id="12430" href="Prelude.Preliminaries.html#12403" class="Function Operator">∣</a> <a id="12432" class="Symbol">=</a> <a id="12434" href="Prelude.Preliminaries.html#12424" class="Bound">x</a>
 <a id="12437" href="Prelude.Preliminaries.html#12407" class="Function">fst</a> <a id="12441" class="Symbol">(</a><a id="12442" href="Prelude.Preliminaries.html#12442" class="Bound">x</a> <a id="12444" href="Prelude.Preliminaries.html#11707" class="InductiveConstructor Operator">,</a> <a id="12446" href="Prelude.Preliminaries.html#12446" class="Bound">y</a><a id="12447" class="Symbol">)</a> <a id="12449" class="Symbol">=</a> <a id="12451" href="Prelude.Preliminaries.html#12442" class="Bound">x</a>

 <a id="12455" href="Prelude.Preliminaries.html#12455" class="Function Operator">∥_∥</a> <a id="12459" href="Prelude.Preliminaries.html#12459" class="Function">snd</a> <a id="12463" class="Symbol">:</a> <a id="12465" class="Symbol">(</a><a id="12466" href="Prelude.Preliminaries.html#12466" class="Bound">z</a> <a id="12468" class="Symbol">:</a> <a id="12470" href="Sigma-Type.html#120" class="Record">Σ</a> <a id="12472" href="Prelude.Preliminaries.html#12382" class="Bound">B</a><a id="12473" class="Symbol">)</a> <a id="12475" class="Symbol">→</a> <a id="12477" href="Prelude.Preliminaries.html#12382" class="Bound">B</a> <a id="12479" class="Symbol">(</a><a id="12480" href="MGS-MLTT.html#2942" class="Function">pr₁</a> <a id="12484" href="Prelude.Preliminaries.html#12466" class="Bound">z</a><a id="12485" class="Symbol">)</a>
 <a id="12488" href="Prelude.Preliminaries.html#12455" class="Function Operator">∥</a> <a id="12490" href="Prelude.Preliminaries.html#12490" class="Bound">x</a> <a id="12492" href="Prelude.Preliminaries.html#11707" class="InductiveConstructor Operator">,</a> <a id="12494" href="Prelude.Preliminaries.html#12494" class="Bound">y</a> <a id="12496" href="Prelude.Preliminaries.html#12455" class="Function Operator">∥</a> <a id="12498" class="Symbol">=</a> <a id="12500" href="Prelude.Preliminaries.html#12494" class="Bound">y</a>
 <a id="12503" href="Prelude.Preliminaries.html#12459" class="Function">snd</a> <a id="12507" class="Symbol">(</a><a id="12508" href="Prelude.Preliminaries.html#12508" class="Bound">x</a> <a id="12510" href="Prelude.Preliminaries.html#11707" class="InductiveConstructor Operator">,</a> <a id="12512" href="Prelude.Preliminaries.html#12512" class="Bound">y</a><a id="12513" class="Symbol">)</a> <a id="12515" class="Symbol">=</a> <a id="12517" href="Prelude.Preliminaries.html#12512" class="Bound">y</a>
