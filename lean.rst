...
In :numref:`equivalence-relations` we saw that an equivalence relation is a symmetric preorder; that is, a reflexive, symmetric, and transitive binary relation. We will see such relations in Lean in a moment, but first let's define preorder in Lean and use this definition as part of the definition of equivalence relation.
...
In :numref:`equivalence-relations` we claimed that there is yet another way to define an equivalence relation, namely, as a binary relation satisfying the following two properties:
