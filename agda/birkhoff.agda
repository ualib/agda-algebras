...
birkhoff 𝒦 𝑨 g eg 𝑨∈ModThV = γ
 ...
 --Let 𝑨 ∈ 𝒲' and let 𝑌 be a set of cardinality max(∣𝐴∣, ω). Choose a surjection ℎ₀ : 𝑌 → 𝐴.
 ...
 --𝑨 ∈ 𝑯(𝔽_{𝒲}(Y)) ⊆ 𝒲` which will complete the proof.
 ...
 --Thus 𝒲 ⊧ 𝑝 ≈ 𝑞, hence (𝑝, 𝑞) ∈ Σ. Since 𝑨 ∈ Mod(Σ) we get 𝑨 ⊧ 𝑝 ≈ 𝑞.
 --Therefore, ℎ(𝑢) = 𝑝^𝑨(ℎ₀ ∘ 𝒚) = 𝑞^𝑨(ℎ₀ ∘ 𝒚) = ℎ(𝑣), as desired.
