...
+  **A level-heterogeneous (large) category of signatures**.  Deferred: useful for morphisms across differing operation/arity levels, but not needed for M4-5a's reduct-packaging goal; the fixed-level `Sig 𝓞 𝓥` is the clean first cut.

## References

+  Issue M4-5 — [Signatures as functors: reducts, expansions, and interpretability](https://github.com/ualib/agda-algebras/issues/338).
+  Issue M4-5a — [Category of signature morphisms](https://github.com/ualib/agda-algebras/issues/339).
