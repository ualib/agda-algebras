...
This section describes how :ref:`subuniverse generation <thm-1-14>` can be implemented formally in Lean_.

We present the following inductive type that implements the **subuniverse generated by a set**; cf. the definition :eq:`subalgebra-inductive` presented above in the informal syntax.
