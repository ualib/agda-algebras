...
%Most of the content of this paper was generated from the literate \agda file
%\HSPlagda and the \LaTeXe file \agdahsp, which are available
%in the \agdaalgebras GitHub repository~\cite{ualib_v2.0.1}.
