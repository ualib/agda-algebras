...
P-idemp-lemma : {𝓤 𝓦 : Universe}{𝒦 : Pred (Algebra 𝓤 𝑆)(OV 𝓤)}
                {𝑨 𝑩 : Algebra (𝓤 ⊔ 𝓦) 𝑆}
 →               𝑨 ∈ P{𝓤}{𝓤 ⊔ 𝓦} 𝒦 → 𝑨 ≅ 𝑩 → 𝑩 ∈ P{𝓤}{𝓤 ⊔ 𝓦} 𝒦
P-idemp-lemma {𝓤} {𝓦} {𝒦} {.(lift-alg 𝑨 (𝓤 ⊔ 𝓦))} {𝑩} (pbase{𝑨} x) A≅B = {!!}
P-idemp-lemma {𝓤} {𝓦} {𝒦} {.(lift-alg 𝑨 (𝓤 ⊔ 𝓦))} {𝑩} (plift{𝑨} x) A≅B = {!!}
P-idemp-lemma {𝓤} {𝓦} {𝒦} {.((∀ i → fst (𝒜 i)) , (λ f 𝒂 i → snd (𝒜 i) f (λ x₁ → 𝒂 x₁ i)))} {𝑩} (prod{I}{𝒜} x) A≅B = {!!}
P-idemp-lemma {𝓤} {𝓦} {𝒦} {𝑨} {𝑩} (piso x x₁) A≅B = {!!}
...
P-idemp' {𝓤} {𝓦} {𝒦} (prod{I}{𝒜} x) = {!!}  -- prod (λ i → P-idemp' (x i))
 where
  l⨅A : Algebra (𝓤 ⊔ 𝓦) 𝑆
  l⨅A = lift-alg (⨅ 𝒜) (𝓤 ⊔ 𝓦)
  ...
  pplA : (i : I) → (lA i) ∈ P{𝓤 ⊔ 𝓦}{𝓤 ⊔ 𝓦}(P{𝓤}{𝓤 ⊔ 𝓦} 𝒦)
  pplA i = pbase{𝓤 ⊔ 𝓦}{𝓤 ⊔ 𝓦}{𝒦 = (P{𝓤}{𝓤 ⊔ 𝓦} 𝒦)} (pA i)
  ...
  pp⨅lA : (⨅ lA) ∈ P{𝓤 ⊔ 𝓦}{𝓤 ⊔ 𝓦} (P{𝓤}{𝓤 ⊔ 𝓦} 𝒦)
  pp⨅lA = prod pplA

  pp⨅A : ⨅ 𝒜 ∈ P{𝓤 ⊔ 𝓦}{𝓤 ⊔ 𝓦} (P{𝓤}{𝓤 ⊔ 𝓦} 𝒦)
  pp⨅A = piso{𝓤 ⊔ 𝓦}{𝓤 ⊔ 𝓦}{𝒦 = (P{𝓤}{𝓤 ⊔ 𝓦} 𝒦)} pp⨅lA ⨅lA≅⨅A

  γ : ⨅ 𝒜 ∈ P{𝓤}{𝓤 ⊔ 𝓦} 𝒦
  γ = P-idemp'{𝓦 = 𝓦} pp⨅A

P-idemp' {𝓤} {𝓦} {𝒦} (piso {𝑨} {𝑩} ppA A≅B) = {!!}
 where
  ppa : 𝑨 ∈ P{𝓤 ⊔ 𝓦}{𝓤 ⊔ 𝓦} (P{𝓤}{𝓤 ⊔ 𝓦} 𝒦)
  ppa = ppA
  ...
  pplA : lA ∈ P{𝓤 ⊔ 𝓦}{𝓤 ⊔ 𝓦}(P{𝓤}{𝓤 ⊔ 𝓦} 𝒦)
  pplA = pbase{𝓤 ⊔ 𝓦}{𝓤 ⊔ 𝓦}{𝒦 = (P{𝓤}{𝓤 ⊔ 𝓦} 𝒦)} pA
  ...
  ppB : 𝑩 ∈ P{𝓤 ⊔ 𝓦}{𝓤 ⊔ 𝓦}(P{𝓤}{𝓤 ⊔ 𝓦} 𝒦)
  ppB = piso{𝓤 ⊔ 𝓦}{𝓤 ⊔ 𝓦}{𝒦 = (P{𝓤}{𝓤 ⊔ 𝓦} 𝒦)} pplA lA≅B
...
-- LEFT OFF HERE --- vvvvvvvvvvvvvvvvvvvvvvvvv ------------------
-- P-lemma : {𝓤 𝓦 : Universe}{𝒦 : Pred (Algebra 𝓤 𝑆)(OV 𝓤)}
--  →        P{𝓤}{𝓦} 𝒦 ⊆ P{𝓤}{𝓤 ⊔ 𝓦} 𝒦

-- P-lemma {𝓤} {𝓦} {𝒦} {.(lift-alg 𝑨 𝓦)} (pbase{𝑨} x) = γ
--  where
--   lAuw = lift-alg 𝑨 (𝓤 ⊔ 𝓦)
--   lAw = lift-alg 𝑨 𝓦
--   plAuw : lAuw ∈ P{𝓤}{𝓤 ⊔ 𝓦} 𝒦
--   plAuw = pbase x

--   γ : lAw ∈ P{𝓤}{𝓤 ⊔ 𝓦} 𝒦
--   γ = {!!}
-- P-lemma {𝓤} {𝓦} {𝒦}{.(lift-alg 𝑨 𝓦)} (plift x) = {!!}
-- P-lemma {𝓤} {𝓦} {𝒦} {.((∀ i → fst (𝒜 i)) , (λ f 𝒂 i → snd (𝒜 i) f (λ x₁ → 𝒂 x₁ i)))} (prod{I}{𝒜} x) = {!!}
-- P-lemma {𝓤} {𝓦} {𝒦} {𝑨} (piso x x₁) = {!!}
-- LEFT OFF HERE --- ^^^^^^^^^^^^^^^^^^^^^^^^ --------------------
