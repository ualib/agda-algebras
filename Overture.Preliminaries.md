...
<a id="lift∼lower"></a><a id="8582" href="Overture.Preliminaries.html#8582" class="Function">lift∼lower</a> <a id="8593" class="Symbol">:</a> <a id="8595" class="Symbol">{</a><a id="8596" href="Overture.Preliminaries.html#8596" class="Bound">A</a> <a id="8598" class="Symbol">:</a> <a id="8600" href="Overture.Preliminaries.html#2824" class="Primitive">Type</a> <a id="8605" href="Overture.Preliminaries.html#3322" class="Generalizable">α</a><a id="8606" class="Symbol">}</a> <a id="8608" class="Symbol">→</a> <a id="8610" href="Level.html#457" class="InductiveConstructor">lift</a> <a id="8615" href="Function.Base.html#1031" class="Function Operator">∘</a> <a id="8617" href="Level.html#470" class="Field">lower</a> <a id="8623" href="Agda.Builtin.Equality.html#151" class="Datatype Operator">≡</a> <a id="8625" href="Overture.Preliminaries.html#5348" class="Function">𝑖𝑑</a> <a id="8628" class="Symbol">(</a><a id="8629" href="Level.html#400" class="Record">Lift</a> <a id="8634" href="Overture.Preliminaries.html#3324" class="Generalizable">β</a> <a id="8636" href="Overture.Preliminaries.html#8596" class="Bound">A</a><a id="8637" class="Symbol">)</a>
<a id="8639" href="Overture.Preliminaries.html#8582" class="Function">lift∼lower</a> <a id="8650" class="Symbol">=</a> <a id="8652" href="Agda.Builtin.Equality.html#208" class="InductiveConstructor">refl</a>

<a id="lower∼lift"></a><a id="8658" href="Overture.Preliminaries.html#8658" class="Function">lower∼lift</a> <a id="8669" class="Symbol">:</a> <a id="8671" class="Symbol">{</a><a id="8672" href="Overture.Preliminaries.html#8672" class="Bound">A</a> <a id="8674" class="Symbol">:</a> <a id="8676" href="Overture.Preliminaries.html#2824" class="Primitive">Type</a> <a id="8681" href="Overture.Preliminaries.html#3322" class="Generalizable">α</a><a id="8682" class="Symbol">}</a> <a id="8684" class="Symbol">→</a> <a id="8686" class="Symbol">(</a><a id="8687" href="Level.html#470" class="Field">lower</a> <a id="8693" class="Symbol">{</a><a id="8694" href="Overture.Preliminaries.html#3322" class="Generalizable">α</a><a id="8695" class="Symbol">}{</a><a id="8697" href="Overture.Preliminaries.html#3324" class="Generalizable">β</a><a id="8698" class="Symbol">})</a> <a id="8701" href="Function.Base.html#1031" class="Function Operator">∘</a> <a id="8703" href="Level.html#457" class="InductiveConstructor">lift</a> <a id="8708" href="Agda.Builtin.Equality.html#151" class="Datatype Operator">≡</a> <a id="8710" href="Overture.Preliminaries.html#5348" class="Function">𝑖𝑑</a> <a id="8713" href="Overture.Preliminaries.html#8672" class="Bound">A</a>
<a id="8715" href="Overture.Preliminaries.html#8658" class="Function">lower∼lift</a> <a id="8726" class="Symbol">=</a> <a id="8728" href="Agda.Builtin.Equality.html#208" class="InductiveConstructor">refl</a>
...
<a id="9264" class="Keyword">module</a> <a id="9271" href="Overture.Preliminaries.html#9271" class="Module">_</a> <a id="9273" class="Symbol">{</a><a id="9274" href="Overture.Preliminaries.html#9274" class="Bound">α</a> <a id="9276" class="Symbol">:</a> <a id="9278" href="Agda.Primitive.html#597" class="Postulate">Level</a><a id="9283" class="Symbol">}{</a><a id="9285" href="Overture.Preliminaries.html#9285" class="Bound">A</a> <a id="9287" class="Symbol">:</a> <a id="9289" href="Overture.Preliminaries.html#2824" class="Primitive">Type</a> <a id="9294" href="Overture.Preliminaries.html#9274" class="Bound">α</a><a id="9295" class="Symbol">}{</a><a id="9297" href="Overture.Preliminaries.html#9297" class="Bound">β</a> <a id="9299" class="Symbol">:</a> <a id="9301" href="Agda.Primitive.html#597" class="Postulate">Level</a><a id="9306" class="Symbol">}{</a><a id="9308" href="Overture.Preliminaries.html#9308" class="Bound">B</a> <a id="9310" class="Symbol">:</a> <a id="9312" href="Overture.Preliminaries.html#9285" class="Bound">A</a> <a id="9314" class="Symbol">→</a> <a id="9316" href="Overture.Preliminaries.html#2824" class="Primitive">Type</a> <a id="9321" href="Overture.Preliminaries.html#9297" class="Bound">β</a> <a id="9323" class="Symbol">}</a> <a id="9325" class="Keyword">where</a>

 <a id="9333" href="Overture.Preliminaries.html#9333" class="Function Operator">_≈_</a> <a id="9337" class="Symbol">:</a>  <a id="9340" class="Symbol">(</a><a id="9341" href="Overture.Preliminaries.html#9341" class="Bound">f</a> <a id="9343" href="Overture.Preliminaries.html#9343" class="Bound">g</a> <a id="9345" class="Symbol">:</a> <a id="9347" class="Symbol">(</a><a id="9348" href="Overture.Preliminaries.html#9348" class="Bound">a</a> <a id="9350" class="Symbol">:</a> <a id="9352" href="Overture.Preliminaries.html#9285" class="Bound">A</a><a id="9353" class="Symbol">)</a> <a id="9355" class="Symbol">→</a> <a id="9357" href="Overture.Preliminaries.html#9308" class="Bound">B</a> <a id="9359" href="Overture.Preliminaries.html#9348" class="Bound">a</a><a id="9360" class="Symbol">)</a> <a id="9362" class="Symbol">→</a> <a id="9364" href="Overture.Preliminaries.html#2824" class="Primitive">Type</a> <a id="9369" class="Symbol">(</a><a id="9370" href="Overture.Preliminaries.html#9274" class="Bound">α</a> <a id="9372" href="Agda.Primitive.html#810" class="Primitive Operator">⊔</a> <a id="9374" href="Overture.Preliminaries.html#9297" class="Bound">β</a><a id="9375" class="Symbol">)</a>
 <a id="9378" href="Overture.Preliminaries.html#9378" class="Bound">f</a> <a id="9380" href="Overture.Preliminaries.html#9333" class="Function Operator">≈</a> <a id="9382" href="Overture.Preliminaries.html#9382" class="Bound">g</a> <a id="9384" class="Symbol">=</a> <a id="9386" class="Symbol">∀</a> <a id="9388" href="Overture.Preliminaries.html#9388" class="Bound">x</a> <a id="9390" class="Symbol">→</a> <a id="9392" href="Overture.Preliminaries.html#9378" class="Bound">f</a> <a id="9394" href="Overture.Preliminaries.html#9388" class="Bound">x</a> <a id="9396" href="Agda.Builtin.Equality.html#151" class="Datatype Operator">≡</a> <a id="9398" href="Overture.Preliminaries.html#9382" class="Bound">g</a> <a id="9400" href="Overture.Preliminaries.html#9388" class="Bound">x</a>

 <a id="9404" class="Keyword">infix</a> <a id="9410" class="Number">8</a> <a id="9412" href="Overture.Preliminaries.html#9333" class="Function Operator">_≈_</a>

 <a id="9418" href="Overture.Preliminaries.html#9418" class="Function">≈IsEquivalence</a> <a id="9433" class="Symbol">:</a> <a id="9435" href="Relation.Binary.Structures.html#1522" class="Record">IsEquivalence</a> <a id="9449" href="Overture.Preliminaries.html#9333" class="Function Operator">_≈_</a>
 <a id="9454" href="Relation.Binary.Structures.html#1568" class="Field">IsEquivalence.refl</a> <a id="9473" href="Overture.Preliminaries.html#9418" class="Function">≈IsEquivalence</a> <a id="9488" class="Symbol">=</a> <a id="9490" class="Symbol">λ</a> <a id="9492" href="Overture.Preliminaries.html#9492" class="Bound">_</a> <a id="9494" class="Symbol">→</a> <a id="9496" href="Agda.Builtin.Equality.html#208" class="InductiveConstructor">refl</a>
 <a id="9502" href="Relation.Binary.Structures.html#1594" class="Field">IsEquivalence.sym</a> <a id="9520" href="Overture.Preliminaries.html#9418" class="Function">≈IsEquivalence</a> <a id="9535" class="Symbol">{</a><a id="9536" href="Overture.Preliminaries.html#9536" class="Bound">f</a><a id="9537" class="Symbol">}{</a><a id="9539" href="Overture.Preliminaries.html#9539" class="Bound">g</a><a id="9540" class="Symbol">}</a> <a id="9542" href="Overture.Preliminaries.html#9542" class="Bound">f≈g</a> <a id="9546" class="Symbol">=</a> <a id="9548" class="Symbol">λ</a> <a id="9550" href="Overture.Preliminaries.html#9550" class="Bound">x</a> <a id="9552" class="Symbol">→</a> <a id="9554" href="Relation.Binary.PropositionalEquality.Core.html#1684" class="Function">sym</a> <a id="9558" class="Symbol">(</a><a id="9559" href="Overture.Preliminaries.html#9542" class="Bound">f≈g</a> <a id="9563" href="Overture.Preliminaries.html#9550" class="Bound">x</a><a id="9564" class="Symbol">)</a>
 <a id="9567" href="Relation.Binary.Structures.html#1620" class="Field">IsEquivalence.trans</a> <a id="9587" href="Overture.Preliminaries.html#9418" class="Function">≈IsEquivalence</a> <a id="9602" class="Symbol">{</a><a id="9603" href="Overture.Preliminaries.html#9603" class="Bound">f</a><a id="9604" class="Symbol">}{</a><a id="9606" href="Overture.Preliminaries.html#9606" class="Bound">g</a><a id="9607" class="Symbol">}{</a><a id="9609" href="Overture.Preliminaries.html#9609" class="Bound">h</a><a id="9610" class="Symbol">}</a> <a id="9612" href="Overture.Preliminaries.html#9612" class="Bound">f≈g</a> <a id="9616" href="Overture.Preliminaries.html#9616" class="Bound">g≈h</a> <a id="9620" class="Symbol">=</a> <a id="9622" class="Symbol">λ</a> <a id="9624" href="Overture.Preliminaries.html#9624" class="Bound">x</a> <a id="9626" class="Symbol">→</a> <a id="9628" href="Relation.Binary.PropositionalEquality.Core.html#1729" class="Function">trans</a> <a id="9634" class="Symbol">(</a><a id="9635" href="Overture.Preliminaries.html#9612" class="Bound">f≈g</a> <a id="9639" href="Overture.Preliminaries.html#9624" class="Bound">x</a><a id="9640" class="Symbol">)</a> <a id="9642" class="Symbol">(</a><a id="9643" href="Overture.Preliminaries.html#9616" class="Bound">g≈h</a> <a id="9647" href="Overture.Preliminaries.html#9624" class="Bound">x</a><a id="9648" class="Symbol">)</a>
...
<a id="≡-by-parts"></a><a id="9815" href="Overture.Preliminaries.html#9815" class="Function">≡-by-parts</a> <a id="9826" class="Symbol">:</a> <a id="9828" class="Symbol">{</a><a id="9829" href="Overture.Preliminaries.html#9829" class="Bound">A</a> <a id="9831" class="Symbol">:</a> <a id="9833" href="Overture.Preliminaries.html#2824" class="Primitive">Type</a> <a id="9838" href="Overture.Preliminaries.html#3322" class="Generalizable">α</a><a id="9839" class="Symbol">}{</a><a id="9841" href="Overture.Preliminaries.html#9841" class="Bound">B</a> <a id="9843" class="Symbol">:</a> <a id="9845" href="Overture.Preliminaries.html#2824" class="Primitive">Type</a> <a id="9850" href="Overture.Preliminaries.html#3324" class="Generalizable">β</a><a id="9851" class="Symbol">}{</a><a id="9853" href="Overture.Preliminaries.html#9853" class="Bound">u</a> <a id="9855" href="Overture.Preliminaries.html#9855" class="Bound">v</a> <a id="9857" class="Symbol">:</a> <a id="9859" href="Overture.Preliminaries.html#9829" class="Bound">A</a> <a id="9861" href="Data.Product.html#1167" class="Function Operator">×</a> <a id="9863" href="Overture.Preliminaries.html#9841" class="Bound">B</a><a id="9864" class="Symbol">}</a> <a id="9866" class="Symbol">→</a> <a id="9868" href="Overture.Preliminaries.html#2937" class="Field">fst</a> <a id="9872" href="Overture.Preliminaries.html#9853" class="Bound">u</a> <a id="9874" href="Agda.Builtin.Equality.html#151" class="Datatype Operator">≡</a> <a id="9876" href="Overture.Preliminaries.html#2937" class="Field">fst</a> <a id="9880" href="Overture.Preliminaries.html#9855" class="Bound">v</a> <a id="9882" class="Symbol">→</a> <a id="9884" href="Overture.Preliminaries.html#2952" class="Field">snd</a> <a id="9888" href="Overture.Preliminaries.html#9853" class="Bound">u</a> <a id="9890" href="Agda.Builtin.Equality.html#151" class="Datatype Operator">≡</a> <a id="9892" href="Overture.Preliminaries.html#2952" class="Field">snd</a> <a id="9896" href="Overture.Preliminaries.html#9855" class="Bound">v</a> <a id="9898" class="Symbol">→</a> <a id="9900" href="Overture.Preliminaries.html#9853" class="Bound">u</a> <a id="9902" href="Agda.Builtin.Equality.html#151" class="Datatype Operator">≡</a> <a id="9904" href="Overture.Preliminaries.html#9855" class="Bound">v</a>
<a id="9906" href="Overture.Preliminaries.html#9815" class="Function">≡-by-parts</a> <a id="9917" href="Agda.Builtin.Equality.html#208" class="InductiveConstructor">refl</a> <a id="9922" href="Agda.Builtin.Equality.html#208" class="InductiveConstructor">refl</a> <a id="9927" class="Symbol">=</a> <a id="9929" href="Agda.Builtin.Equality.html#208" class="InductiveConstructor">refl</a>
...
<a id="transport"></a><a id="10052" href="Overture.Preliminaries.html#10052" class="Function">transport</a> <a id="10062" class="Symbol">:</a> <a id="10064" class="Symbol">{</a><a id="10065" href="Overture.Preliminaries.html#10065" class="Bound">A</a> <a id="10067" class="Symbol">:</a> <a id="10069" href="Overture.Preliminaries.html#2824" class="Primitive">Type</a> <a id="10074" href="Overture.Preliminaries.html#3322" class="Generalizable">α</a> <a id="10076" class="Symbol">}</a> <a id="10078" class="Symbol">(</a><a id="10079" href="Overture.Preliminaries.html#10079" class="Bound">B</a> <a id="10081" class="Symbol">:</a> <a id="10083" href="Overture.Preliminaries.html#10065" class="Bound">A</a> <a id="10085" class="Symbol">→</a> <a id="10087" href="Overture.Preliminaries.html#2824" class="Primitive">Type</a> <a id="10092" href="Overture.Preliminaries.html#3324" class="Generalizable">β</a><a id="10093" class="Symbol">)</a> <a id="10095" class="Symbol">{</a><a id="10096" href="Overture.Preliminaries.html#10096" class="Bound">x</a> <a id="10098" href="Overture.Preliminaries.html#10098" class="Bound">y</a> <a id="10100" class="Symbol">:</a> <a id="10102" href="Overture.Preliminaries.html#10065" class="Bound">A</a><a id="10103" class="Symbol">}</a> <a id="10105" class="Symbol">→</a> <a id="10107" href="Overture.Preliminaries.html#10096" class="Bound">x</a> <a id="10109" href="Agda.Builtin.Equality.html#151" class="Datatype Operator">≡</a> <a id="10111" href="Overture.Preliminaries.html#10098" class="Bound">y</a> <a id="10113" class="Symbol">→</a> <a id="10115" href="Overture.Preliminaries.html#10079" class="Bound">B</a> <a id="10117" href="Overture.Preliminaries.html#10096" class="Bound">x</a> <a id="10119" class="Symbol">→</a> <a id="10121" href="Overture.Preliminaries.html#10079" class="Bound">B</a> <a id="10123" href="Overture.Preliminaries.html#10098" class="Bound">y</a>
<a id="10125" href="Overture.Preliminaries.html#10052" class="Function">transport</a> <a id="10135" href="Overture.Preliminaries.html#10135" class="Bound">B</a> <a id="10137" href="Agda.Builtin.Equality.html#208" class="InductiveConstructor">refl</a> <a id="10142" class="Symbol">=</a> <a id="10144" href="Function.Base.html#615" class="Function">id</a>
