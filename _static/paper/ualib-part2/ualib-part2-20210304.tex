...
\titlerunning{The Agda UALib, Part 2: homomorphisms, terms, and subalgebras}
...
This is part 2 in a 3-paper series describing the \agdaualib, and this installment is structured as follows.
%
...
\firstsentence{\ualibHomBasic}{\urlHomBasic}
...
\firstsentence{\ualibNoether}{\urlNoether}

\input{12Noether.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Isomorphisms}
\firstsentence{\ualibIsomorphisms}{\urlIsomorphisms}

\input{13Isomorphisms.tex}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Homomorphic Images}
\firstsentence{\ualibHomomorphicImages}{\urlHomomorphicImages}

\input{14HomomorphicImages.tex}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Types for Terms}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Basic Definitions}
\firstsentence{\ualibTermsBasic}{\urlTermsBasic}
...
\firstsentence{\ualibOperations}{\urlOperations}

\input{22Operations.tex}
...
\section{Subalgebra Types}
  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%- [Subuniverses](Subalgebras.Subuniverses.html) 
\subsection{Subuniverses}
\firstsentence{\ualibSubuniverses}{\urlSubuniverses}

\input{31Subuniverses.tex}

  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%- [Subalgebras](Subalgebras.Subalgebras) 
\subsection{Subalgebras}
\firstsentence{\ualibSubalgebras}{\urlSubalgebras}

\input{32Subalgebras.tex}

  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
- [Univalent Subalgebras](Subalgebras.Univalent.html) 
\subsection{Univalent Subalgebras}
\firstsentence{\ualibUnivalent}{\urlUnivalent}
