...
\title{A Constructive, Machine-checked Proof\break of Birkhoff's Variety Theorem}

\author{%
\name{\href{https://williamdemeo.gitlab.io/}{William DeMeo}}
\address{\href{https://www.mff.cuni.cz/en/ka}{Department of Algebra}\\
  Charles University\\
  %Katedra Algebry, Univerzita Karlova\\
  %Sokolovska 83, 186 00 Praha 8, Czech Republic}
  %186 00 Praha 8, \v{C}esk\'{a} Republika}
  186 00 Prague 8, Czech Republic}
\email{williamdemeo@gmail.com}
\and
\name{\href{https://hyeyoungshin.github.io/}{Hyeyoung Shin}}
\address{
  \href{https://prl-prg.github.io/}{Faculty of Information Technology}\\
  Czech Technical University\\
%  Thákurova 9, 160 00 Prague 6, Czech Republic}
    160 00 Prague 6, Czech Republic}
\email{hyeyoungshinw@gmail.com}
\and
\name{\href{http://www.cs.cmu.edu/~ssomayya/}{Siva Somayyajula}}
\address{\href{https://www.cs.cmu.edu/}{Department of Computer Science}\\
