...
This section presents the {[}UALib.Terms.Basic{]}{[}{]} module of the
...
\paragraph{The inductive type of
terms}\label{the-inductive-type-of-terms}

We define a type called \texttt{Term} which, not surprisingly,
represents the type of terms. The type \texttt{X\ :\ \ 𝒰\ ̇} represents
an arbitrary collection of variable symbols.
...
\href{UALib.Terms.html}{↑ UALib.Terms}
