...
type in MLTT. It represents \defn{definitional equality}. (For definition and discussion, see \url{https://ncatlab.org/nlab/show/equality\#definitional\_equality}.)
The refl type we use is a standard one. It is defined in the \am{Identity-Type}
module of the \typetopology library, but (apart from slightly different syntax)
it is equivalent to the identity type used in most other Agda libraries.
