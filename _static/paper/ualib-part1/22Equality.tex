...
We make refl available by importing it from the \am{Identity-Type} module. However, we first repeat the definition here (inside a hidden submodule) for clarity.
\ccpad
\begin{code}%
