...
Recall the discussion in \S\ref{sec:lifts-altern-univ} of the difficulties one encounters when working with a noncummulative universe hierarchy. There we made a promise to provide some domain-specific lifting and lowering methods. Here we fulfill this promise by supplying a couple of bespoke tools designed to work with our operation and algebra types.
\ccpad
\begin{code}%
\>[0][@{}l@{\AgdaIndent{0}}]%
% \>[1]\AgdaKeyword{open}\AgdaSpace{}%
...
% 's noncummulative hierarchy of type universes.
