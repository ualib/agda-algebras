...
\paragraph*{Truncated equivalence relations}%\label{truncated-preorders-and-equivalences}
Using the \af{is-subsingleton-valued} type defined earlier, we define the type of equivalence relations that have ``unique membership proofs,'' as follows.
\ccpad
\begin{code}%
\>[1]\AgdaKeyword{record}\AgdaSpace{}%
