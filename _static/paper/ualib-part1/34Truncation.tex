...
To see the point of the types just defined, suppose \af{con-prop-ext} \ab A \ab 𝓦 holds. Then we can prove that logically equivalent continuous propositions of type \af{ConProp} \ab A \ab 𝓦 are equivalent. In other words, under the stated hypotheses, we obtain an extensionality lemma for continuous propositions.
\ccpad
\begin{code}%
% \>[0]\<%
% \\
