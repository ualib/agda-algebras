...
We defined a type called \af{DepRel} (in \S\ref{continuous-relation-types}) to represent relations of arbitrary arity over an arbitrary collection of sorts. Here we introduce a new type of \emph{truncated dependent relations}, the inhabitants of which we call \defn{dependent propositions}. (Assume the context includes \AgdaBound{𝓤}\AgdaSpace{}%
\AgdaSymbol{:}\AgdaSpace{}%
