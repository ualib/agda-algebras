...
The \am{Universes} module includes a number of symbols used to denote universes in Agda. In particular, following Escardó, we refer to universe levels using capitalized script letters from near the end of the alphabet, e.g., \ab 𝓤, \ab 𝓥, \ab 𝓦, \ab 𝓧, \ab 𝓨, \ab𝓩, etc. To this list we add one more, as follows: \AgdaKeyword{variable}\AgdaSpace{}%
