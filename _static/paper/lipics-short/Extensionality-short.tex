...
%% \end{code}
%% \ccpad
Pointwise equality of functions is typically what one means in informal settings when one says that two functions are equal. In~\cite{MHE}, Escardo defines pointwise equality of (dependent) function in the \href{https://github.com/martinescardo/TypeTopology}{Type Topology} this way
\ccpad
\begin{code}
