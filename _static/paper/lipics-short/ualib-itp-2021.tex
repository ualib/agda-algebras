...
As mentioned in \S~\ref{sec:contributions}, a constructive version of Birkhoff's theorem was presented by Carlstr\"om in~\cite{Carlstrom:2008}. We should determine how the two new hypothesis required by Carlstr\"om %% adds to the classical theorem in order to make it constructive 
