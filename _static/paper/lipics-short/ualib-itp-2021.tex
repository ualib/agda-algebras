...
\input{aux/AgdaPreliminaries.tex}
...
As mentioned in \S~\ref{sec:introduction}, Carlstr\"om in~\cite{Carlstrom:2008} proved a constructive version of Birkhoff's theorem. We would like to know how the two new hypothesis that Carlstr\"om adds to the classical theorem in order to make it constructive compares with the assumptions we make in our Agda proof.
