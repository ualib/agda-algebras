...
SL : structure Sig-2 {ℓ₀}   -- (one binary operation symbol)
               Sig∅ {ℓ₀}    -- (no relation symbols)
...
nae3sat : structure Sig∅          -- (no operation symbols)
                    Sig-3  {ℓ₀}   -- (one ternary relation symbol)
