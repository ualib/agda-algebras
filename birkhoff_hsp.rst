...
.. proof:theorem:: 
   ...
   .. container:: toggle
      ...
      By :ref:`Theorem 4.21 <thm-4-21>`, :math:`h_0` extends to a (surjective) homomorphism :math:`h : 𝕋(Y) → 𝔸`.
...
Let :math:`u,v ∈ T(Y)` and assume that :math:`g(u) = g(v)`. Since :math:`𝕋(Y)` is generated by :math:`Y`, by :ref:`Theorem 4.21 <thm-4-21>`, there is an integer :math:`n`, terms :math:`p, q ∈ T(X_n)`, and :math:`y_1, \dots, y_n ∈ Y` such that :math:`u = p^{𝕋(Y)}(y_1, \dots, y_n)` and :math:`v = q^{𝕋(Y)}(y_1,\dots, y_n)`, by Theorem [thm:4.32].
